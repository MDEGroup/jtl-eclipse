	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ASPPackage.NODE: {
				...
				if (result == null) result = caseFunction(node);
			...
			case ASPPackage.PROP: {
				...
				if (result == null) result = caseFunction(prop);
			...
			case ASPPackage.EDGE: {
				...
				if (result == null) result = caseFunction(edge);
			...
			case ASPPackage.METANODE: {
				...
				if (result == null) result = caseFunction(metanode);
			...
			case ASPPackage.METAPROP: {
				...
				if (result == null) result = caseFunction(metaprop);
			...
			case ASPPackage.METAEDGE: {
				...
				if (result == null) result = caseFunction(metaedge);
