...
public class TransformationImpl extends MinimalEObjectImpl.Container implements Transformation {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<Element>(Element.class, this, ASPPackage.TRANSFORMATION__ELEMENTS, ASPPackage.ELEMENT__TRANSFORMATION);
		}
		return elements;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, ASPPackage.TRANSFORMATION__CONSTRAINTS, ASPPackage.CONSTRAINT__TRANSFORMATION);
		}
		return constraints;
	}
