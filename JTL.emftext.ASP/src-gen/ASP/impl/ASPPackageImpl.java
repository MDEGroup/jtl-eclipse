...
public class ASPPackageImpl extends EPackageImpl implements ASPPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getConstraint_Direction(), this.getLiteral(), null, "direction", null, 0, 1, Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
