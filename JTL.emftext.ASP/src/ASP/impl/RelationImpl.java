 ...
 * </p>
 * <ul>
 *   <li>{@link ASP.impl.RelationImpl#getPatterns <em>Patterns</em>}</li>
 *   <li>{@link ASP.impl.RelationImpl#getId <em>Id</em>}</li>
...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	...
	public EList<Pattern> getPatterns() {
		if (patterns == null) {
			patterns = new EObjectContainmentEList<Pattern>(Pattern.class, this, ASPPackage.RELATION__PATTERNS);
		}
		return patterns;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPPackage.RELATION__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ASPPackage.RELATION__PATTERNS:
