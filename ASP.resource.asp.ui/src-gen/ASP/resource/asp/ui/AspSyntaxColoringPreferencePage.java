 ...
 */
public class AspSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AspSyntaxColoringPreferencePage() {
		super();
		
		ASP.resource.asp.mopp.AspMetaInformation metaInformation = new ASP.resource.asp.mopp.AspMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ASP.resource.asp.ui.AspSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASP.resource.asp.ui.AspSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ASP.resource.asp.ui.AspPixelConverter pixelConverter = new ASP.resource.asp.ui.AspPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ASP.resource.asp.ui.AspEditor) {
			ASP.resource.asp.ui.AspEditor emfTextEditor = (ASP.resource.asp.ui.AspEditor) editor;
