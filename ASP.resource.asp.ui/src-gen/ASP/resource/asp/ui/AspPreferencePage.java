 ...
 */
public class AspPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ASP.resource.asp.ui.AspUIPlugin.getDefault().getPreferenceStore());
		setDescription("Asp Text Editor Preferences");
	}
