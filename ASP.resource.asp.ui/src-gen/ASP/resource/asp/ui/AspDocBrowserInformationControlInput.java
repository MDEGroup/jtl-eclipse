 ...
 * olInput</code>.
 */
public class AspDocBrowserInformationControlInput {
	
	private final AspDocBrowserInformationControlInput fPrevious;
	private AspDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AspDocBrowserInformationControlInput(AspDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AspDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AspDocBrowserInformationControlInput getNext() {
		return fNext;
	}
