...
public class AspLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(ASP.resource.asp.mopp.AspPlugin.DEBUG_MODEL_ID);
			...
			ASP.resource.asp.debug.AspLineBreakpoint lineBreakpoint = new ASP.resource.asp.debug.AspLineBreakpoint(resource, lineNumber + 1);
