 ...
 */
public class AspCodeFoldingManager {
	
	private class FoldingUpdateListener implements ASP.resource.asp.IAspBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ASP.resource.asp.ui.AspEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ASP.resource.asp.ui.AspEditor) {
				ASP.resource.asp.ui.AspEditor editor = (ASP.resource.asp.ui.AspEditor) workbenchPart;
	...
	protected ASP.resource.asp.ui.AspEditor editor;
	 ...
	 */
	public AspCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ASP.resource.asp.ui.AspEditor textEditor) {
	...
	private void addCloseListener(final ASP.resource.asp.ui.AspEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ASP.resource.asp.ui.AspUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ASP.resource.asp.IAspTextResource textResource = (ASP.resource.asp.IAspTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
