...
/**
 * A text editor for 'asp' models.
 * <p>
 * This editor has id <code>ASP.resource.asp.ui.AspEditor</code>
 * The editor's context menu has id <code>ASP.resource.asp.EditorContext</code>. 
 * The editor's ruler context menu has id
 * <code>ASP.resource.asp.EditorRuler</code>.
 * </p>
 */
public class AspEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, ASP.resource.asp.IAspResourceProvider, ASP.resource.asp.ui.IAspBracketHandlerProvider, ASP.resource.asp.ui.IAspAnnotationModelProvider {
	
	private ASP.resource.asp.ui.AspHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private ASP.resource.asp.ui.AspCodeFoldingManager codeFoldingManager;
	private ASP.resource.asp.ui.AspBackgroundParsingStrategy bgParsingStrategy = new ASP.resource.asp.ui.AspBackgroundParsingStrategy();
	private java.util.Collection<ASP.resource.asp.IAspBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<ASP.resource.asp.IAspBackgroundParsingListener>();
	private ASP.resource.asp.ui.AspColorManager colorManager = new ASP.resource.asp.ui.AspColorManager();
	private ASP.resource.asp.ui.AspOutlinePage outlinePage;
	...
	private ASP.resource.asp.ui.AspPropertySheetPage propertySheetPage;
	...
	private ASP.resource.asp.ui.IAspBracketHandler bracketHandler;
	...
	public AspEditor() {
		super();
		setSourceViewerConfiguration(new ASP.resource.asp.ui.AspSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), AspEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								ASP.resource.asp.IAspTextResource currentResource = getResource();
				...
				ASP.resource.asp.ui.AspUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("ASP.resource.asp.EditorContext");
		setRulerContextMenuId("ASP.resource.asp.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new ASP.resource.asp.ui.AspHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new ASP.resource.asp.ui.AspCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		ASP.resource.asp.mopp.AspNature.activate(inputFile.getProject());
		...
		ASP.resource.asp.IAspTextResource loadedResource = (ASP.resource.asp.IAspTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				ASP.resource.asp.IAspTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof ASP.resource.asp.IAspTextResource) {
					setResource((ASP.resource.asp.IAspTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					ASP.resource.asp.ui.AspUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the AspEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				ASP.resource.asp.ui.AspUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(ASP.resource.asp.IAspTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new ASP.resource.asp.ui.AspOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new ASP.resource.asp.ui.AspPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			ASP.resource.asp.IAspTextResource textResource = (ASP.resource.asp.IAspTextResource) element.eResource();
			...
			ASP.resource.asp.IAspTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				ASP.resource.asp.IAspTextToken token = lexer.getNextToken();
			...
			ASP.resource.asp.ui.AspUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!AspEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(ASP.resource.asp.IAspBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (ASP.resource.asp.IAspBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public ASP.resource.asp.ui.IAspBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(ASP.resource.asp.ui.IAspBracketHandler bracketHandler) {
