 ...
 * @since 3.2
 */
public class AspBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private ASP.resource.asp.ui.AspDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AspBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AspBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AspBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof ASP.resource.asp.ui.AspDocBrowserInformationControlInput);
		...
		fInput= (ASP.resource.asp.ui.AspDocBrowserInformationControlInput) input;
		...
		ASP.resource.asp.ui.AspHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = ASP.resource.asp.ui.AspHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public ASP.resource.asp.ui.AspDocBrowserInformationControlInput getInput() {
		return fInput;
	}
