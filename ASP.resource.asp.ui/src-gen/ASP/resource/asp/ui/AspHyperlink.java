 ...
 */
public class AspHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AspHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				ASP.resource.asp.mopp.AspPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
