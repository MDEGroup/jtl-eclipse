 ...
 */
public class AspNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new ASP.resource.asp.mopp.AspMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("ASP.resource.asp.ui");
							...
							String natureID = ASP.resource.asp.mopp.AspNature.NATURE_ID;
							...
							for (String builderID : ASP.resource.asp.mopp.AspNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								ASP.resource.asp.mopp.AspMetaInformation info = new ASP.resource.asp.mopp.AspMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = ASP.resource.asp.ui.AspUIPlugin.getDefault().getBundle();
