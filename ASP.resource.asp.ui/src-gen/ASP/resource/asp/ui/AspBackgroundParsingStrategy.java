 ...
 */
public class AspBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final ASP.resource.asp.IAspTextResource resource, final ASP.resource.asp.ui.AspEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final ASP.resource.asp.IAspTextResource resource, final ASP.resource.asp.ui.AspEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final ASP.resource.asp.IAspTextResource resource, final ASP.resource.asp.ui.AspEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof ASP.resource.asp.mopp.AspResource) {
							ASP.resource.asp.mopp.AspResource concreteResource = (ASP.resource.asp.mopp.AspResource) resource;
