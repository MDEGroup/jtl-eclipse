 ...
 */
public class AspCompletionProposal implements java.lang.Comparable<AspCompletionProposal> {
	 ...
	 */
	private ASP.resource.asp.mopp.AspExpectedTerminal expectedTerminal;
	...
	public AspCompletionProposal(ASP.resource.asp.mopp.AspExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AspCompletionProposal(ASP.resource.asp.mopp.AspExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AspCompletionProposal(ASP.resource.asp.mopp.AspExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public ASP.resource.asp.mopp.AspExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof AspCompletionProposal) {
			AspCompletionProposal other = (AspCompletionProposal) object;
	...
	public int compareTo(AspCompletionProposal object) {
		if (object instanceof AspCompletionProposal) {
			AspCompletionProposal other = (AspCompletionProposal) object;
