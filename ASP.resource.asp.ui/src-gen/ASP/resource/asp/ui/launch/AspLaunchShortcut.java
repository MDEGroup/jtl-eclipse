 ...
 */
public class AspLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new ASP.resource.asp.mopp.AspMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(ASP.resource.asp.launch.AspLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			ASP.resource.asp.mopp.AspPlugin.logError("Exception while launching selection", e);
		}
	}
