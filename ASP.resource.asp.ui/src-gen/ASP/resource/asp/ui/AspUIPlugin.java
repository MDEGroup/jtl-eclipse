 ...
 */
public class AspUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "ASP.resource.asp.ui";
	public static final String EDITOR_ID = "ASP.resource.asp.ui.AspEditor";
	...
	private static AspUIPlugin plugin;
	...
	public static AspUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspUIPlugin.PLUGIN_ID, message);
		}
		final AspUIPlugin pluginInstance = AspUIPlugin.getDefault();
