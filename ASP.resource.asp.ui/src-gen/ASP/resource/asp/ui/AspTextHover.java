 ...
 */
public class AspTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private ASP.resource.asp.IAspHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final ASP.resource.asp.ui.AspBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(ASP.resource.asp.ui.AspBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			ASP.resource.asp.ui.AspDocBrowserInformationControlInput infoInput = (ASP.resource.asp.ui.AspDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					ASP.resource.asp.ui.AspHyperlink hyperlink = new ASP.resource.asp.ui.AspHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (ASP.resource.asp.ui.AspBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				ASP.resource.asp.ui.AspBrowserInformationControl iControl = new ASP.resource.asp.ui.AspBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof ASP.resource.asp.ui.AspDocBrowserInformationControlInput) {
							ASP.resource.asp.ui.AspDocBrowserInformationControlInput input = (ASP.resource.asp.ui.AspDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (ASP.resource.asp.ui.AspBrowserInformationControl.isAvailable(parent)) {
				ASP.resource.asp.ui.AspBrowserInformationControl iControl = new ASP.resource.asp.ui.AspBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AspTextHover(ASP.resource.asp.IAspResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new ASP.resource.asp.ui.AspUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((ASP.resource.asp.ui.AspDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private ASP.resource.asp.ui.AspDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private ASP.resource.asp.ui.AspDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, ASP.resource.asp.ui.AspDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				ASP.resource.asp.ui.AspHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			ASP.resource.asp.ui.AspHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			ASP.resource.asp.ui.AspHTMLPrinter.insertPageProlog(buffer, 0, ASP.resource.asp.ui.AspTextHover.getStyleSheet());
			ASP.resource.asp.ui.AspHTMLPrinter.addPageEpilog(buffer);
			return new ASP.resource.asp.ui.AspDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = ASP.resource.asp.ui.AspHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(ASP.resource.asp.ui.AspUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return ASP.resource.asp.util.AspStreamUtil.getContent(styleSheetURL.openStream());
