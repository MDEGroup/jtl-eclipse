 ...
 * a specified depth.
 */
public class AspOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public AspOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = ASP.resource.asp.util.AspStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof ASP.resource.asp.ui.AspEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			ASP.resource.asp.mopp.AspPlugin.logError("Exception while refreshing outline view", e);
		}
	}
