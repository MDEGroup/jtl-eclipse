 ...
 */
public class AspNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AspNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new asp file");
