 ...
 * </p>
 * <ul>
 *   <li>{@link ASPM.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link ASPM.impl.LocatedElementImpl#getCommentsBefore <em>Comments Before</em>}</li>
 *   <li>{@link ASPM.impl.LocatedElementImpl#getCommentsAfter <em>Comments After</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LocatedElementImpl extends MinimalEObjectImpl.Container implements LocatedElement {
	...
	protected EClass eStaticClass() {
		return ASPMPackage.Literals.LOCATED_ELEMENT;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASPMPackage.LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public EList<String> getCommentsBefore() {
		if (commentsBefore == null) {
			commentsBefore = new EDataTypeEList<String>(String.class, this, ASPMPackage.LOCATED_ELEMENT__COMMENTS_BEFORE);
		}
	...
	public EList<String> getCommentsAfter() {
		if (commentsAfter == null) {
			commentsAfter = new EDataTypeEList<String>(String.class, this, ASPMPackage.LOCATED_ELEMENT__COMMENTS_AFTER);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ASPMPackage.LOCATED_ELEMENT__LOCATION:
				return getLocation();
			case ASPMPackage.LOCATED_ELEMENT__COMMENTS_BEFORE:
				return getCommentsBefore();
			case ASPMPackage.LOCATED_ELEMENT__COMMENTS_AFTER:
