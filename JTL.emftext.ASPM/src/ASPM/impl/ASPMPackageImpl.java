 ...
 * @generated
 */
public class ASPMPackageImpl extends EPackageImpl implements ASPMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ASPM.ASPMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ASPMPackageImpl() {
		super(eNS_URI, ASPMFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ASPMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ASPMPackage init() {
		if (isInited) return (ASPMPackage)EPackage.Registry.INSTANCE.getEPackage(ASPMPackage.eNS_URI);

		// Obtain or create and register package
		ASPMPackageImpl theASPMPackage = (ASPMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ASPMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ASPMPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theASPMPackage.createPackageContents();

		// Initialize created meta-data
		theASPMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theASPMPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ASPMPackage.eNS_URI, theASPMPackage);
		return theASPMPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getModel_Props() {
	 ...
	 * @generated
	 */
	public EAttribute getNode_IDtrace() {
	 ...
	 * @generated
	 */
	public EReference getNode_Model() {
	 ...
	 * @generated
	 */
	public EAttribute getProp_IDtrace() {
	...
	public EAttribute getProp_Value() {
		return (EAttribute)propEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getProp_Model() {
		return (EReference)propEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getProp_Owner() {
		return (EReference)propEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getProp_OwnerTrace() {
		return (EAttribute)propEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEdge_IDtrace() {
	 ...
	 * @generated
	 */
	public EAttribute getEdge_SourceTrace() {
	 ...
	 * @generated
	 */
	public EAttribute getEdge_TargetTrace() {
	 ...
	 * @generated
	 */
	public EReference getEdge_Model() {
	 ...
	 * @generated
	 */
	public ASPMFactory getASPMFactory() {
		return (ASPMFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(propEClass, PROP__OWNER_TRACE);
		...
		createEAttribute(edgeEClass, EDGE__SOURCE_TRACE);
		createEReference(edgeEClass, EDGE__TARGET);
		createEAttribute(edgeEClass, EDGE__TARGET_TRACE);
	...
	public void initializePackageContents() {
		...
		modelEClass.getESuperTypes().add(this.getLocatedElement());
		nodeEClass.getESuperTypes().add(this.getLocatedElement());
		...
		initEAttribute(getProp_OwnerTrace(), ecorePackage.getEString(), "ownerTrace", null, 1, 1, Prop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getEdge_SourceTrace(), ecorePackage.getEString(), "sourceTrace", null, 1, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getEdge_TargetTrace(), ecorePackage.getEString(), "targetTrace", null, 1, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
