 ...
 */
public class JtlCodeFoldingManager {
	
	private class FoldingUpdateListener implements JTL.resource.jtl.IJtlBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(JTL.resource.jtl.ui.JtlEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof JTL.resource.jtl.ui.JtlEditor) {
				JTL.resource.jtl.ui.JtlEditor editor = (JTL.resource.jtl.ui.JtlEditor) workbenchPart;
	...
	protected JTL.resource.jtl.ui.JtlEditor editor;
	 ...
	 */
	public JtlCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,JTL.resource.jtl.ui.JtlEditor textEditor) {
	...
	private void addCloseListener(final JTL.resource.jtl.ui.JtlEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			JTL.resource.jtl.ui.JtlUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		JTL.resource.jtl.IJtlTextResource textResource = (JTL.resource.jtl.IJtlTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
