 ...
 */
public class JtlCompletionProposal implements java.lang.Comparable<JtlCompletionProposal> {
	 ...
	 */
	private JTL.resource.jtl.mopp.JtlExpectedTerminal expectedTerminal;
	...
	public JtlCompletionProposal(JTL.resource.jtl.mopp.JtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public JtlCompletionProposal(JTL.resource.jtl.mopp.JtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public JtlCompletionProposal(JTL.resource.jtl.mopp.JtlExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public JTL.resource.jtl.mopp.JtlExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof JtlCompletionProposal) {
			JtlCompletionProposal other = (JtlCompletionProposal) object;
	...
	public int compareTo(JtlCompletionProposal object) {
		if (object instanceof JtlCompletionProposal) {
			JtlCompletionProposal other = (JtlCompletionProposal) object;
