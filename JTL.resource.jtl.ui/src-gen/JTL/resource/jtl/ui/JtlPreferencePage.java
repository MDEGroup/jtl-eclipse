 ...
 */
public class JtlPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(JTL.resource.jtl.ui.JtlUIPlugin.getDefault().getPreferenceStore());
		setDescription("Jtl Text Editor Preferences");
	}
