 ...
 * olInput</code>.
 */
public class JtlDocBrowserInformationControlInput {
	
	private final JtlDocBrowserInformationControlInput fPrevious;
	private JtlDocBrowserInformationControlInput fNext;
	 ...
	 */
	public JtlDocBrowserInformationControlInput(JtlDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public JtlDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public JtlDocBrowserInformationControlInput getNext() {
		return fNext;
	}
