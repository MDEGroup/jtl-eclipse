 ...
 */
public class JtlTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private JTL.resource.jtl.IJtlHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final JTL.resource.jtl.ui.JtlBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(JTL.resource.jtl.ui.JtlBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput infoInput = (JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					JTL.resource.jtl.ui.JtlHyperlink hyperlink = new JTL.resource.jtl.ui.JtlHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (JTL.resource.jtl.ui.JtlBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				JTL.resource.jtl.ui.JtlBrowserInformationControl iControl = new JTL.resource.jtl.ui.JtlBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput) {
							JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput input = (JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (JTL.resource.jtl.ui.JtlBrowserInformationControl.isAvailable(parent)) {
				JTL.resource.jtl.ui.JtlBrowserInformationControl iControl = new JTL.resource.jtl.ui.JtlBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public JtlTextHover(JTL.resource.jtl.IJtlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new JTL.resource.jtl.ui.JtlUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				JTL.resource.jtl.ui.JtlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			JTL.resource.jtl.ui.JtlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			JTL.resource.jtl.ui.JtlHTMLPrinter.insertPageProlog(buffer, 0, JTL.resource.jtl.ui.JtlTextHover.getStyleSheet());
			JTL.resource.jtl.ui.JtlHTMLPrinter.addPageEpilog(buffer);
			return new JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = JTL.resource.jtl.ui.JtlHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(JTL.resource.jtl.ui.JtlUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return JTL.resource.jtl.util.JtlStreamUtil.getContent(styleSheetURL.openStream());
