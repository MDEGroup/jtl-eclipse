...
public class JtlNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private JTL.resource.jtl.ui.JtlNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public JtlNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new JTL.resource.jtl.ui.JtlNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			JTL.resource.jtl.ui.JtlUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			JTL.resource.jtl.ui.JtlUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new JTL.resource.jtl.mopp.JtlMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new JTL.resource.jtl.mopp.JtlMetaInformation().getSyntaxName();
	}
	
	public JTL.resource.jtl.IJtlMetaInformation getMetaInformation() {
