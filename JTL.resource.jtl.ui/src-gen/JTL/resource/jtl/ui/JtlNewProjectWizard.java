 ...
 */
public class JtlNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new JTL.resource.jtl.mopp.JtlMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("JTL.resource.jtl.ui");
							...
							String natureID = JTL.resource.jtl.mopp.JtlNature.NATURE_ID;
							...
							for (String builderID : JTL.resource.jtl.mopp.JtlNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								JTL.resource.jtl.mopp.JtlMetaInformation info = new JTL.resource.jtl.mopp.JtlMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = JTL.resource.jtl.ui.JtlUIPlugin.getDefault().getBundle();
