 ...
 */
public class JtlNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public JtlNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new jtl file");
