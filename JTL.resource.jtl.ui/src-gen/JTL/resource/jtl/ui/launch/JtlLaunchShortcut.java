 ...
 */
public class JtlLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new JTL.resource.jtl.mopp.JtlMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(JTL.resource.jtl.launch.JtlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			JTL.resource.jtl.mopp.JtlPlugin.logError("Exception while launching selection", e);
		}
	}
