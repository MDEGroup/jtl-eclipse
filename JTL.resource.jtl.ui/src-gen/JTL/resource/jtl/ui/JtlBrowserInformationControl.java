 ...
 * @since 3.2
 */
public class JtlBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput fInput;
	 ...
	 */
	public JtlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public JtlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public JtlBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput);
		...
		fInput= (JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput) input;
		...
		JTL.resource.jtl.ui.JtlHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = JTL.resource.jtl.ui.JtlHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public JTL.resource.jtl.ui.JtlDocBrowserInformationControlInput getInput() {
		return fInput;
	}
