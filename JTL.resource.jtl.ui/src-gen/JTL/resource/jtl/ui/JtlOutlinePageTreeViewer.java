 ...
 * a specified depth.
 */
public class JtlOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public JtlOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = JTL.resource.jtl.util.JtlStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof JTL.resource.jtl.ui.JtlEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			JTL.resource.jtl.mopp.JtlPlugin.logError("Exception while refreshing outline view", e);
		}
	}
