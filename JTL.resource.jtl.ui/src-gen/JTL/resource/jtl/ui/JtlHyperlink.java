 ...
 */
public class JtlHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public JtlHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				JTL.resource.jtl.mopp.JtlPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
