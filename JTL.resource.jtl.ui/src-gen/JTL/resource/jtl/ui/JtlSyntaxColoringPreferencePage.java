 ...
 */
public class JtlSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public JtlSyntaxColoringPreferencePage() {
		super();
		
		JTL.resource.jtl.mopp.JtlMetaInformation metaInformation = new JTL.resource.jtl.mopp.JtlMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = JTL.resource.jtl.ui.JtlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, JTL.resource.jtl.ui.JtlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		JTL.resource.jtl.ui.JtlPixelConverter pixelConverter = new JTL.resource.jtl.ui.JtlPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof JTL.resource.jtl.ui.JtlEditor) {
			JTL.resource.jtl.ui.JtlEditor emfTextEditor = (JTL.resource.jtl.ui.JtlEditor) editor;
