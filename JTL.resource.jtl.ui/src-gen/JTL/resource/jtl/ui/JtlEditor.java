...
/**
 * A text editor for 'jtl' models.
 * <p>
 * This editor has id <code>JTL.resource.jtl.ui.JtlEditor</code>
 * The editor's context menu has id <code>JTL.resource.jtl.EditorContext</code>. 
 * The editor's ruler context menu has id
 * <code>JTL.resource.jtl.EditorRuler</code>.
 * </p>
 */
public class JtlEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, JTL.resource.jtl.IJtlResourceProvider, JTL.resource.jtl.ui.IJtlBracketHandlerProvider, JTL.resource.jtl.ui.IJtlAnnotationModelProvider {
	
	private JTL.resource.jtl.ui.JtlHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private JTL.resource.jtl.ui.JtlCodeFoldingManager codeFoldingManager;
	private JTL.resource.jtl.ui.JtlBackgroundParsingStrategy bgParsingStrategy = new JTL.resource.jtl.ui.JtlBackgroundParsingStrategy();
	private java.util.Collection<JTL.resource.jtl.IJtlBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<JTL.resource.jtl.IJtlBackgroundParsingListener>();
	private JTL.resource.jtl.ui.JtlColorManager colorManager = new JTL.resource.jtl.ui.JtlColorManager();
	private JTL.resource.jtl.ui.JtlOutlinePage outlinePage;
	...
	private JTL.resource.jtl.ui.JtlPropertySheetPage propertySheetPage;
	...
	private JTL.resource.jtl.ui.IJtlBracketHandler bracketHandler;
	...
	public JtlEditor() {
		super();
		setSourceViewerConfiguration(new JTL.resource.jtl.ui.JtlSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), JtlEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								JTL.resource.jtl.IJtlTextResource currentResource = getResource();
				...
				JTL.resource.jtl.ui.JtlUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("JTL.resource.jtl.EditorContext");
		setRulerContextMenuId("JTL.resource.jtl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new JTL.resource.jtl.ui.JtlHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new JTL.resource.jtl.ui.JtlCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		JTL.resource.jtl.mopp.JtlNature.activate(inputFile.getProject());
		...
		JTL.resource.jtl.IJtlTextResource loadedResource = (JTL.resource.jtl.IJtlTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				JTL.resource.jtl.IJtlTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof JTL.resource.jtl.IJtlTextResource) {
					setResource((JTL.resource.jtl.IJtlTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					JTL.resource.jtl.ui.JtlUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the JtlEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				JTL.resource.jtl.ui.JtlUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(JTL.resource.jtl.IJtlTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new JTL.resource.jtl.ui.JtlOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new JTL.resource.jtl.ui.JtlPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			JTL.resource.jtl.IJtlTextResource textResource = (JTL.resource.jtl.IJtlTextResource) element.eResource();
			...
			JTL.resource.jtl.IJtlTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				JTL.resource.jtl.IJtlTextToken token = lexer.getNextToken();
			...
			JTL.resource.jtl.ui.JtlUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!JtlEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(JTL.resource.jtl.IJtlBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (JTL.resource.jtl.IJtlBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public JTL.resource.jtl.ui.IJtlBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(JTL.resource.jtl.ui.IJtlBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof JTL.resource.jtl.IJtlTextResource)) {
					return false;
				}
				JTL.resource.jtl.IJtlTextResource textResource = (JTL.resource.jtl.IJtlTextResource) resource;
				JTL.resource.jtl.IJtlLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
