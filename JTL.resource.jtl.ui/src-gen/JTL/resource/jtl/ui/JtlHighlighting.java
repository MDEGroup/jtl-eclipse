 ...
 */
public class JtlHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static JTL.resource.jtl.ui.JtlPositionHelper positionHelper = new JTL.resource.jtl.ui.JtlPositionHelper();
	...
	private JTL.resource.jtl.ui.JtlTokenScanner scanner;
	...
	private JTL.resource.jtl.ui.JtlEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private JTL.resource.jtl.ui.JtlOccurrence occurrence;
	private JTL.resource.jtl.ui.JtlBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, JTL.resource.jtl.IJtlBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public JtlHighlighting(JTL.resource.jtl.IJtlTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, JTL.resource.jtl.ui.JtlColorManager colorManager, JTL.resource.jtl.ui.JtlEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = JTL.resource.jtl.ui.JtlUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new JTL.resource.jtl.ui.JtlTokenScanner(textResource, colorManager);
		occurrence = new JTL.resource.jtl.ui.JtlOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new JTL.resource.jtl.ui.JtlBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(JTL.resource.jtl.ui.JtlPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, JTL.resource.jtl.ui.JtlPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(JTL.resource.jtl.ui.JtlEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, JTL.resource.jtl.ui.JtlPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, JTL.resource.jtl.ui.JtlPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(JTL.resource.jtl.ui.JtlPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new JTL.resource.jtl.ui.JtlEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
