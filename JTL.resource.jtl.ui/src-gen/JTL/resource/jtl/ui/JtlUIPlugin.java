 ...
 */
public class JtlUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "JTL.resource.jtl.ui";
	public static final String EDITOR_ID = "JTL.resource.jtl.ui.JtlEditor";
	...
	private static JtlUIPlugin plugin;
	...
	public static JtlUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JtlUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JtlUIPlugin.PLUGIN_ID, message);
		}
		final JtlUIPlugin pluginInstance = JtlUIPlugin.getDefault();
