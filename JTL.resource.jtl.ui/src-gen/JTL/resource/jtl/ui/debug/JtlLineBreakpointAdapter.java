...
public class JtlLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(JTL.resource.jtl.mopp.JtlPlugin.DEBUG_MODEL_ID);
			...
			JTL.resource.jtl.debug.JtlLineBreakpoint lineBreakpoint = new JTL.resource.jtl.debug.JtlLineBreakpoint(resource, lineNumber + 1);
