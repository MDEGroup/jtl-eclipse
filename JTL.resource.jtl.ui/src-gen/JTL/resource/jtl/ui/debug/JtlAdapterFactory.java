 ...
 * 
 */
package JTL.resource.jtl.ui.debug;

@SuppressWarnings("restriction")
public class JtlAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new JTL.resource.jtl.mopp.JtlMetaInformation().getSyntaxName())) {
					return new JTL.resource.jtl.ui.debug.JtlLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof JTL.resource.jtl.debug.JtlDebugVariable) {
			final JTL.resource.jtl.debug.JtlDebugVariable variable = (JTL.resource.jtl.debug.JtlDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof JTL.resource.jtl.debug.JtlDebugVariable) {
			final JTL.resource.jtl.debug.JtlDebugVariable variable = (JTL.resource.jtl.debug.JtlDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							JTL.resource.jtl.debug.JtlDebugValue castedValue = (JTL.resource.jtl.debug.JtlDebugValue) value;
