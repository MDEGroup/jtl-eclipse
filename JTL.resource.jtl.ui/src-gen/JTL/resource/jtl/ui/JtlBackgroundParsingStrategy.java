 ...
 */
public class JtlBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final JTL.resource.jtl.IJtlTextResource resource, final JTL.resource.jtl.ui.JtlEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final JTL.resource.jtl.IJtlTextResource resource, final JTL.resource.jtl.ui.JtlEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final JTL.resource.jtl.IJtlTextResource resource, final JTL.resource.jtl.ui.JtlEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof JTL.resource.jtl.mopp.JtlResource) {
							JTL.resource.jtl.mopp.JtlResource concreteResource = (JTL.resource.jtl.mopp.JtlResource) resource;
