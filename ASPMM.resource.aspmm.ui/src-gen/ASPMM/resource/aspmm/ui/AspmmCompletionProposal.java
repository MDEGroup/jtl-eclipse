 ...
 */
public class AspmmCompletionProposal implements java.lang.Comparable<AspmmCompletionProposal> {
	 ...
	 */
	private ASPMM.resource.aspmm.mopp.AspmmExpectedTerminal expectedTerminal;
	...
	public AspmmCompletionProposal(ASPMM.resource.aspmm.mopp.AspmmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AspmmCompletionProposal(ASPMM.resource.aspmm.mopp.AspmmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AspmmCompletionProposal(ASPMM.resource.aspmm.mopp.AspmmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public ASPMM.resource.aspmm.mopp.AspmmExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof AspmmCompletionProposal) {
			AspmmCompletionProposal other = (AspmmCompletionProposal) object;
	...
	public int compareTo(AspmmCompletionProposal object) {
		if (object instanceof AspmmCompletionProposal) {
			AspmmCompletionProposal other = (AspmmCompletionProposal) object;
