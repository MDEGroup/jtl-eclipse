...
public class AspmmNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private ASPMM.resource.aspmm.ui.AspmmNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public AspmmNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new ASPMM.resource.aspmm.ui.AspmmNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			ASPMM.resource.aspmm.ui.AspmmUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			ASPMM.resource.aspmm.ui.AspmmUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getSyntaxName();
	}
