 ...
 */
public class AspmmSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AspmmSyntaxColoringPreferencePage() {
		super();
		
		ASPMM.resource.aspmm.mopp.AspmmMetaInformation metaInformation = new ASPMM.resource.aspmm.mopp.AspmmMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPMM.resource.aspmm.ui.AspmmSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ASPMM.resource.aspmm.ui.AspmmPixelConverter pixelConverter = new ASPMM.resource.aspmm.ui.AspmmPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ASPMM.resource.aspmm.ui.AspmmEditor) {
			ASPMM.resource.aspmm.ui.AspmmEditor emfTextEditor = (ASPMM.resource.aspmm.ui.AspmmEditor) editor;
