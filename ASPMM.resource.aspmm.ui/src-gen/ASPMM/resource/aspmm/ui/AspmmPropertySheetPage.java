...
public class AspmmPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof ASPMM.resource.aspmm.ui.AspmmEObjectSelection) {
			final ASPMM.resource.aspmm.ui.AspmmEObjectSelection selection = (ASPMM.resource.aspmm.ui.AspmmEObjectSelection) iSelection;
