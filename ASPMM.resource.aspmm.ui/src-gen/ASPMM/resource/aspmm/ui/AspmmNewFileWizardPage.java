 ...
 */
public class AspmmNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AspmmNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new aspmm file");
