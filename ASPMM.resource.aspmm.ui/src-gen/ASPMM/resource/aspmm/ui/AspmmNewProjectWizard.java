 ...
 */
public class AspmmNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("ASPMM.resource.aspmm.ui");
							...
							String natureID = ASPMM.resource.aspmm.mopp.AspmmNature.NATURE_ID;
							...
							for (String builderID : ASPMM.resource.aspmm.mopp.AspmmNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								ASPMM.resource.aspmm.mopp.AspmmMetaInformation info = new ASPMM.resource.aspmm.mopp.AspmmMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = ASPMM.resource.aspmm.ui.AspmmUIPlugin.getDefault().getBundle();
