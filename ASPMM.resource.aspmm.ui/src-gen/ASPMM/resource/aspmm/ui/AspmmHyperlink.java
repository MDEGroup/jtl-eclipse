 ...
 */
public class AspmmHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AspmmHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				ASPMM.resource.aspmm.mopp.AspmmPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
