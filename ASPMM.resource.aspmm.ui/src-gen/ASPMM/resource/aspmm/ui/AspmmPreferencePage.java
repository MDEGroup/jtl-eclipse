 ...
 */
public class AspmmPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ASPMM.resource.aspmm.ui.AspmmUIPlugin.getDefault().getPreferenceStore());
		setDescription("Aspmm Text Editor Preferences");
	}
