 ...
 */
public class AspmmLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(ASPMM.resource.aspmm.launch.AspmmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			ASPMM.resource.aspmm.mopp.AspmmPlugin.logError("Exception while launching selection", e);
		}
	}
