 ...
 * a specified depth.
 */
public class AspmmOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public AspmmOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = ASPMM.resource.aspmm.util.AspmmStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof ASPMM.resource.aspmm.ui.AspmmEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			ASPMM.resource.aspmm.mopp.AspmmPlugin.logError("Exception while refreshing outline view", e);
		}
	}
