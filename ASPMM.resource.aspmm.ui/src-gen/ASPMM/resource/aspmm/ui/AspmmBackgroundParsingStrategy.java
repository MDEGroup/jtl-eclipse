 ...
 */
public class AspmmBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final ASPMM.resource.aspmm.IAspmmTextResource resource, final ASPMM.resource.aspmm.ui.AspmmEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final ASPMM.resource.aspmm.IAspmmTextResource resource, final ASPMM.resource.aspmm.ui.AspmmEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final ASPMM.resource.aspmm.IAspmmTextResource resource, final ASPMM.resource.aspmm.ui.AspmmEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof ASPMM.resource.aspmm.mopp.AspmmResource) {
							ASPMM.resource.aspmm.mopp.AspmmResource concreteResource = (ASPMM.resource.aspmm.mopp.AspmmResource) resource;
