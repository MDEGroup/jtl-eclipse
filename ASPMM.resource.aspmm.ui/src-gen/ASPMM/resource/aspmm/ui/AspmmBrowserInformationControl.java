 ...
 * @since 3.2
 */
public class AspmmBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AspmmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AspmmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AspmmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput);
		...
		fInput= (ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput) input;
		...
		ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput getInput() {
		return fInput;
	}
