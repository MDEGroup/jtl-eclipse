 ...
 */
public class AspmmCodeFoldingManager {
	
	private class FoldingUpdateListener implements ASPMM.resource.aspmm.IAspmmBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ASPMM.resource.aspmm.ui.AspmmEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ASPMM.resource.aspmm.ui.AspmmEditor) {
				ASPMM.resource.aspmm.ui.AspmmEditor editor = (ASPMM.resource.aspmm.ui.AspmmEditor) workbenchPart;
	...
	protected ASPMM.resource.aspmm.ui.AspmmEditor editor;
	 ...
	 */
	public AspmmCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ASPMM.resource.aspmm.ui.AspmmEditor textEditor) {
	...
	private void addCloseListener(final ASPMM.resource.aspmm.ui.AspmmEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ASPMM.resource.aspmm.ui.AspmmUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ASPMM.resource.aspmm.IAspmmTextResource textResource = (ASPMM.resource.aspmm.IAspmmTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
