 ...
 * olInput</code>.
 */
public class AspmmDocBrowserInformationControlInput {
	
	private final AspmmDocBrowserInformationControlInput fPrevious;
	private AspmmDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AspmmDocBrowserInformationControlInput(AspmmDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AspmmDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AspmmDocBrowserInformationControlInput getNext() {
		return fNext;
	}
