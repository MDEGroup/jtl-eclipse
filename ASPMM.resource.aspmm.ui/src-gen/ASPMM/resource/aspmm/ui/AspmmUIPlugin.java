 ...
 */
public class AspmmUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "ASPMM.resource.aspmm.ui";
	public static final String EDITOR_ID = "ASPMM.resource.aspmm.ui.AspmmEditor";
	...
	private static AspmmUIPlugin plugin;
	
	public AspmmUIPlugin() {
		super();
	}
	...
	public static AspmmUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspmmUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspmmUIPlugin.PLUGIN_ID, message);
		}
		final AspmmUIPlugin pluginInstance = AspmmUIPlugin.getDefault();
