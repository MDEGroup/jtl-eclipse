 ...
 */
public class AspmmTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private ASPMM.resource.aspmm.IAspmmHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput infoInput = (ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					ASPMM.resource.aspmm.ui.AspmmHyperlink hyperlink = new ASPMM.resource.aspmm.ui.AspmmHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl iControl = new ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput) {
							ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput input = (ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl.isAvailable(parent)) {
				ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl iControl = new ASPMM.resource.aspmm.ui.AspmmBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AspmmTextHover(ASPMM.resource.aspmm.IAspmmResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new ASPMM.resource.aspmm.ui.AspmmUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.insertPageProlog(buffer, 0, ASPMM.resource.aspmm.ui.AspmmTextHover.getStyleSheet());
			ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.addPageEpilog(buffer);
			return new ASPMM.resource.aspmm.ui.AspmmDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = ASPMM.resource.aspmm.ui.AspmmHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(ASPMM.resource.aspmm.ui.AspmmUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return ASPMM.resource.aspmm.util.AspmmStreamUtil.getContent(styleSheetURL.openStream());
