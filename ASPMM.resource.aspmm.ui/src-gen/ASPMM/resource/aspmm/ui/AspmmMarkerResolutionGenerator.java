...
public class AspmmMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(ASPMM.resource.aspmm.IAspmmOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof ASPMM.resource.aspmm.mopp.AspmmResource) {
					ASPMM.resource.aspmm.mopp.AspmmResource customResource = (ASPMM.resource.aspmm.mopp.AspmmResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<ASPMM.resource.aspmm.IAspmmQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final ASPMM.resource.aspmm.IAspmmQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									ASPMM.resource.aspmm.ui.AspmmUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			ASPMM.resource.aspmm.ui.AspmmUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<ASPMM.resource.aspmm.IAspmmQuickFix> getQuickFixes(ASPMM.resource.aspmm.IAspmmTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					ASPMM.resource.aspmm.IAspmmQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
