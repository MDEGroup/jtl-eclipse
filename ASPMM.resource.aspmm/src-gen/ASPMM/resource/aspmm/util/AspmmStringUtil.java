...
public class AspmmStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, ASPMM.resource.aspmm.IAspmmFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, ASPMM.resource.aspmm.IAspmmFunction1<String, T> toStringFunction) {
