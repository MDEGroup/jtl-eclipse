 ...
 */
public class AspmmResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new ASPMM.resource.aspmm.util.AspmmInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new ASPMM.resource.aspmm.util.AspmmInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static ASPMM.resource.aspmm.mopp.AspmmResource getResource(java.io.File file) {
	...
	public static ASPMM.resource.aspmm.mopp.AspmmResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (ASPMM.resource.aspmm.mopp.AspmmResource) resource;
	}
	 ...
	 */
	public static ASPMM.Metamodel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static ASPMM.Metamodel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (ASPMM.Metamodel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static ASPMM.Metamodel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		ASPMM.resource.aspmm.IAspmmTextResource resource = (ASPMM.resource.aspmm.IAspmmTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (ASPMM.resource.aspmm.IAspmmTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		ASPMM.resource.aspmm.IAspmmTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
