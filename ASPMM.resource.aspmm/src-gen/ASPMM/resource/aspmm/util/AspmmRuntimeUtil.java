...
public class AspmmRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			ASPMM.resource.aspmm.mopp.AspmmPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			ASPMM.resource.aspmm.mopp.AspmmPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
