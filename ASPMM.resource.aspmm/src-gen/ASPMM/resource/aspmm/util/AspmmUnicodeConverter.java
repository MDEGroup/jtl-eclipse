 ...
 * to 4 bytes).
 */
public class AspmmUnicodeConverter extends ASPMM.resource.aspmm.mopp.AspmmInputStreamProcessor {
	 ...
	 */
	public AspmmUnicodeConverter(java.io.InputStream inputStream) {
