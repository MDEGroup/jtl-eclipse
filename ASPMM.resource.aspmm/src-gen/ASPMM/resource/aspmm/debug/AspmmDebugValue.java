...
public class AspmmDebugValue extends ASPMM.resource.aspmm.debug.AspmmDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public AspmmDebugValue(ASPMM.resource.aspmm.debug.AspmmDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
