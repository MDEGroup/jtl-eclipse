...
public class AspmmStackFrame extends ASPMM.resource.aspmm.debug.AspmmDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private ASPMM.resource.aspmm.debug.AspmmDebugTarget target;
	private String name;
	private int id;
	...
	public AspmmStackFrame(ASPMM.resource.aspmm.debug.AspmmDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = ASPMM.resource.aspmm.util.AspmmStringUtil.decode(data, ',');
	...
	private ASPMM.resource.aspmm.debug.AspmmDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		ASPMM.resource.aspmm.debug.AspmmStackFrame other = (ASPMM.resource.aspmm.debug.AspmmStackFrame) obj;
		if (name == null) {
