 ...
 */
public class AspmmEnumerationTerminal extends ASPMM.resource.aspmm.grammar.AspmmTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public AspmmEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, ASPMM.resource.aspmm.grammar.AspmmCardinality cardinality, int mandatoryOccurrencesAfter) {
