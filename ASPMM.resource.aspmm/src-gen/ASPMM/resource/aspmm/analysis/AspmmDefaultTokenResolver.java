 ...
 */
public class AspmmDefaultTokenResolver implements ASPMM.resource.aspmm.IAspmmTokenResolver {
	 ...
	 */
	public AspmmDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AspmmDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ASPMM.resource.aspmm.IAspmmTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : ASPMM.resource.aspmm.grammar.AspmmGrammarInformationProvider.INSTANCE.getKeywords()) {
