 ...
 * given name.
 */
public class AspmmReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements ASPMM.resource.aspmm.IAspmmReferenceCache {
	...
	private ASPMM.resource.aspmm.IAspmmNameProvider nameProvider;
	
	public AspmmReferenceCache(ASPMM.resource.aspmm.IAspmmNameProvider nameProvider) {
		super();
