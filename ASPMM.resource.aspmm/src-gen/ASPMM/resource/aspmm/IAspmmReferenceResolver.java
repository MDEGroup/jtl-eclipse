 ...
 * resolver
 */
public interface IAspmmReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends ASPMM.resource.aspmm.IAspmmConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, ASPMM.resource.aspmm.IAspmmReferenceResolveResult<ReferenceType> result);
