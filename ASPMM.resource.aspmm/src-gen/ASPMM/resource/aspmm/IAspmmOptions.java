 ...
 */
public interface IAspmmOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new ASPMM.resource.aspmm.mopp.AspmmMetaInformation().getResourcePostProcessorProviderOptionKey();
