...
/**
 * A IAspmmReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IAspmmReferenceResolverSwitch extends ASPMM.resource.aspmm.IAspmmConfigurable {
