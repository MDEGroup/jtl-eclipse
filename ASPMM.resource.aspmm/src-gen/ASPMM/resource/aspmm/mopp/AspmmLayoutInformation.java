...
/**
 * AspmmLayoutInformation objects are used to store layout information that is
 ...
 * AspmmLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AspmmLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AspmmLayoutInformation {
	 ...
	 */
	private final ASPMM.resource.aspmm.grammar.AspmmSyntaxElement syntaxElement;
	...
	public AspmmLayoutInformation(ASPMM.resource.aspmm.grammar.AspmmSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ASPMM.resource.aspmm.grammar.AspmmSyntaxElement getSyntaxElement() {
