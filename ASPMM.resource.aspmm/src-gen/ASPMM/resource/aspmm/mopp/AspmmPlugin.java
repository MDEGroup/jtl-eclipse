 ...
 */
public class AspmmPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "ASPMM.resource.aspmm";
	/**
	...
	private static AspmmPlugin plugin;
	...
	public static AspmmPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, AspmmPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, AspmmPlugin.PLUGIN_ID, message);
		}
		final AspmmPlugin pluginInstance = AspmmPlugin.getDefault();
