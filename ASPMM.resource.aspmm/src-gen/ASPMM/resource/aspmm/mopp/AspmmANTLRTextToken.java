...
public class AspmmANTLRTextToken extends ASPMM.resource.aspmm.mopp.AspmmTextToken {
	
	private final static ASPMM.resource.aspmm.IAspmmMetaInformation metaInformation = new ASPMM.resource.aspmm.mopp.AspmmMetaInformation();
	
	public AspmmANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
