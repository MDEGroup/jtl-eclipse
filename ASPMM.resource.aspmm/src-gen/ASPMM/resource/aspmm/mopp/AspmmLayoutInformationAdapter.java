...
/**
 * A AspmmLayoutInformationAdapter is used to store layout information that is
 ...
 * AspmmLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class AspmmLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<ASPMM.resource.aspmm.mopp.AspmmLayoutInformation> layoutInformations = new java.util.ArrayList<ASPMM.resource.aspmm.mopp.AspmmLayoutInformation>();
	...
	public java.util.List<ASPMM.resource.aspmm.mopp.AspmmLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(ASPMM.resource.aspmm.mopp.AspmmLayoutInformation layoutInformation) {
