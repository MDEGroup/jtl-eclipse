...
public class AspmmNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "ASPMM.resource.aspmm.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ASPMM.resource.aspmm.mopp.AspmmBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ASPMM.resource.aspmm.mopp.AspmmBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
