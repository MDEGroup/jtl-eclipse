 ...
 */
public class AspmmExpectedTerminal {
	...
	private ASPMM.resource.aspmm.IAspmmExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private ASPMM.resource.aspmm.grammar.AspmmContainmentTrace containmentTrace;
	
	public AspmmExpectedTerminal(org.eclipse.emf.ecore.EObject container, ASPMM.resource.aspmm.IAspmmExpectedElement terminal, int followSetID, ASPMM.resource.aspmm.grammar.AspmmContainmentTrace containmentTrace) {
		super();
	...
	public ASPMM.resource.aspmm.IAspmmExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		AspmmExpectedTerminal otherExpectedTerminal = (AspmmExpectedTerminal) o;
	...
	public ASPMM.resource.aspmm.grammar.AspmmContainmentTrace getContainmentTrace() {
