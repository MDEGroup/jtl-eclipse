 ...
 * given name.
 */
public class AspmReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements ASPM.resource.aspm.IAspmReferenceCache {
	...
	private ASPM.resource.aspm.IAspmNameProvider nameProvider;
	
	public AspmReferenceCache(ASPM.resource.aspm.IAspmNameProvider nameProvider) {
		super();
