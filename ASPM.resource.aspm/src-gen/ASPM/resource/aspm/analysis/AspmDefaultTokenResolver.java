 ...
 */
public class AspmDefaultTokenResolver implements ASPM.resource.aspm.IAspmTokenResolver {
	 ...
	 */
	public AspmDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AspmDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ASPM.resource.aspm.IAspmTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : ASPM.resource.aspm.grammar.AspmGrammarInformationProvider.INSTANCE.getKeywords()) {
