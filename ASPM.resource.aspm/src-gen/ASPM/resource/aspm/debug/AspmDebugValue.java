...
public class AspmDebugValue extends ASPM.resource.aspm.debug.AspmDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public AspmDebugValue(ASPM.resource.aspm.debug.AspmDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
