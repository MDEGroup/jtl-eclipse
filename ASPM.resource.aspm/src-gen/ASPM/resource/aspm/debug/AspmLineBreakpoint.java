...
public class AspmLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "ASPM.resource.aspm.debug.lineBreakpoint.marker";
	
	public AspmLineBreakpoint() {
		super();
	}
	
	public AspmLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(ASPM.resource.aspm.debug.AspmDebugTarget target) {
		try {
	...
	public void remove(ASPM.resource.aspm.debug.AspmDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
