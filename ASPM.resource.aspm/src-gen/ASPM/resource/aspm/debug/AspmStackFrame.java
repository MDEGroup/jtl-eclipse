...
public class AspmStackFrame extends ASPM.resource.aspm.debug.AspmDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private ASPM.resource.aspm.debug.AspmDebugTarget target;
	private String name;
	private int id;
	...
	public AspmStackFrame(ASPM.resource.aspm.debug.AspmDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = ASPM.resource.aspm.util.AspmStringUtil.decode(data, ',');
	...
	private ASPM.resource.aspm.debug.AspmDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		ASPM.resource.aspm.debug.AspmStackFrame other = (ASPM.resource.aspm.debug.AspmStackFrame) obj;
		if (name == null) {
