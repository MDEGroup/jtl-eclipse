 ...
 * resolver
 */
public interface IAspmReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends ASPM.resource.aspm.IAspmConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, ASPM.resource.aspm.IAspmReferenceResolveResult<ReferenceType> result);
