 ...
 */
public interface IAspmOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new ASPM.resource.aspm.mopp.AspmMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new ASPM.resource.aspm.mopp.AspmMetaInformation().getResourcePostProcessorProviderOptionKey();
