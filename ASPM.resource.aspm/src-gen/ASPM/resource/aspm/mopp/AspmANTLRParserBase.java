...
public abstract class AspmANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements ASPM.resource.aspm.IAspmTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<ASPM.resource.aspm.IAspmCommand<ASPM.resource.aspm.IAspmTextResource>> postParseCommands;
	 ...
	 */
	private ASPM.resource.aspm.mopp.AspmTokenResolveResult tokenResolveResult = new ASPM.resource.aspm.mopp.AspmTokenResolveResult();
	
	protected ASPM.resource.aspm.mopp.AspmMetaInformation metaInformation = new ASPM.resource.aspm.mopp.AspmMetaInformation();
	
	public AspmANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public AspmANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, ASPM.resource.aspm.grammar.AspmSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		layoutInformationAdapter.addLayoutInformation(new ASPM.resource.aspm.mopp.AspmLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = ASPM.resource.aspm.util.AspmStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(ASPM.resource.aspm.IAspmOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(ASPM.resource.aspm.IAspmOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, ASPM.resource.aspm.mopp.AspmDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = ASPM.resource.aspm.util.AspmMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof ASPM.resource.aspm.mopp.AspmDummyEObject);
			ASPM.resource.aspm.mopp.AspmDummyEObject dummy = (ASPM.resource.aspm.mopp.AspmDummyEObject) object;
	...
	protected ASPM.resource.aspm.mopp.AspmTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected ASPM.resource.aspm.mopp.AspmReferenceResolverSwitch getReferenceResolverSwitch() {
		ASPM.resource.aspm.mopp.AspmReferenceResolverSwitch resolverSwitch = (ASPM.resource.aspm.mopp.AspmReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
