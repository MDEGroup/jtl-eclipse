...
public class AspmBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "ASPM.resource.aspm.builder";
	
	private ASPM.resource.aspm.IAspmBuilder defaultBuilder = new ASPM.resource.aspm.mopp.AspmBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		ASPM.resource.aspm.IAspmBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			ASPM.resource.aspm.mopp.AspmResource customResource = (ASPM.resource.aspm.mopp.AspmResource) resourceSet.getResource(uri, true);
			new ASPM.resource.aspm.mopp.AspmMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public ASPM.resource.aspm.IAspmBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new ASPM.resource.aspm.mopp.AspmMarkerHelper().getMarkerID(ASPM.resource.aspm.AspmEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		ASPM.resource.aspm.mopp.AspmTaskItemBuilder taskItemBuilder = new ASPM.resource.aspm.mopp.AspmTaskItemBuilder();
		new ASPM.resource.aspm.mopp.AspmMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new ASPM.resource.aspm.mopp.AspmMetaInformation().getSyntaxName())) {
