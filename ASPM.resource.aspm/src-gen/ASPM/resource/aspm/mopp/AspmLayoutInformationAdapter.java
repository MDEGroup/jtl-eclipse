...
/**
 * A AspmLayoutInformationAdapter is used to store layout information that is
 ...
 * AspmLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class AspmLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<ASPM.resource.aspm.mopp.AspmLayoutInformation> layoutInformations = new java.util.ArrayList<ASPM.resource.aspm.mopp.AspmLayoutInformation>();
	...
	public java.util.List<ASPM.resource.aspm.mopp.AspmLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(ASPM.resource.aspm.mopp.AspmLayoutInformation layoutInformation) {
