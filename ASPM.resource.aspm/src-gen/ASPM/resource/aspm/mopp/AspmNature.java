...
public class AspmNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "ASPM.resource.aspm.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ASPM.resource.aspm.mopp.AspmBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ASPM.resource.aspm.mopp.AspmBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
