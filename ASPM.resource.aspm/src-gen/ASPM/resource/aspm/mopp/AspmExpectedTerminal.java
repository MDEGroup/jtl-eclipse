 ...
 */
public class AspmExpectedTerminal {
	...
	private ASPM.resource.aspm.IAspmExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private ASPM.resource.aspm.grammar.AspmContainmentTrace containmentTrace;
	
	public AspmExpectedTerminal(org.eclipse.emf.ecore.EObject container, ASPM.resource.aspm.IAspmExpectedElement terminal, int followSetID, ASPM.resource.aspm.grammar.AspmContainmentTrace containmentTrace) {
		super();
	...
	public ASPM.resource.aspm.IAspmExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		AspmExpectedTerminal otherExpectedTerminal = (AspmExpectedTerminal) o;
	...
	public ASPM.resource.aspm.grammar.AspmContainmentTrace getContainmentTrace() {
