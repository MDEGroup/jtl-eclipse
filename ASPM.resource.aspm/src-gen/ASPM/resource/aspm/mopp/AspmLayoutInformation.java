...
/**
 * AspmLayoutInformation objects are used to store layout information that is
 ...
 * AspmLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AspmLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AspmLayoutInformation {
	 ...
	 */
	private final ASPM.resource.aspm.grammar.AspmSyntaxElement syntaxElement;
	...
	public AspmLayoutInformation(ASPM.resource.aspm.grammar.AspmSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ASPM.resource.aspm.grammar.AspmSyntaxElement getSyntaxElement() {
