 ...
 * delegates.
 */
public class AspmLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends ASPM.resource.aspm.util.AbstractAspmInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, ASPM.resource.aspm.util.AbstractAspmInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final ASPM.resource.aspm.debug.AspmDebuggableInterpreter<ResultType, ContextType> interpreter = new ASPM.resource.aspm.debug.AspmDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		ASPM.resource.aspm.debug.AspmDebuggerListener<ResultType, ContextType> debugListener = new ASPM.resource.aspm.debug.AspmDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		ASPM.resource.aspm.debug.AspmDebugProcess process = new ASPM.resource.aspm.debug.AspmDebugProcess(launch);
		launch.addDebugTarget(new ASPM.resource.aspm.debug.AspmDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(ASPM.resource.aspm.launch.AspmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return ASPM.resource.aspm.util.AspmResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ASPM.resource.aspm.mopp.AspmPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
