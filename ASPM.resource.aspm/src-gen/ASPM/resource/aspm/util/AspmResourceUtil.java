...
public class AspmResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new ASPM.resource.aspm.util.AspmInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new ASPM.resource.aspm.util.AspmInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static ASPM.resource.aspm.mopp.AspmResource getResource(java.io.File file) {
	...
	public static ASPM.resource.aspm.mopp.AspmResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new ASPM.resource.aspm.mopp.AspmMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (ASPM.resource.aspm.mopp.AspmResource) resource;
	}
	 ...
	 */
	public static ASPM.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static ASPM.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (ASPM.Model) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static ASPM.Model getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		ASPM.resource.aspm.IAspmTextResource resource = (ASPM.resource.aspm.IAspmTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (ASPM.resource.aspm.IAspmTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		ASPM.resource.aspm.IAspmTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
