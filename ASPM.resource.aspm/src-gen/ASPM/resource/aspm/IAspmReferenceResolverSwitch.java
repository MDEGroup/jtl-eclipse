...
/**
 * A IAspmReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IAspmReferenceResolverSwitch extends ASPM.resource.aspm.IAspmConfigurable {
