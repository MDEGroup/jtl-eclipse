...
/**
 * Concrete analyzer class for model extraction with smodels-format.
 * 
...
public class SModelsOutputAnalyzer extends OutputAnalyzer {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.startsWith("Answer"))  {
                        ...
                        if (line.startsWith("Stable Model: ")) {
                            model = new Model();
                            // Go straight after string "Stable Model ";
                            tmp = line.substring("Stable Model: ".length()).split(" ");   
