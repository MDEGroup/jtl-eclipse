...
public class JtlResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new JTL.resource.jtl.util.JtlInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new JTL.resource.jtl.util.JtlInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static JTL.resource.jtl.mopp.JtlResource getResource(java.io.File file) {
	...
	public static JTL.resource.jtl.mopp.JtlResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new JTL.resource.jtl.mopp.JtlMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (JTL.resource.jtl.mopp.JtlResource) resource;
	}
	 ...
	 */
	public static JTL.JTL.Transformation getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static JTL.JTL.Transformation getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (JTL.JTL.Transformation) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static JTL.JTL.Transformation getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		JTL.resource.jtl.IJtlTextResource resource = (JTL.resource.jtl.IJtlTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (JTL.resource.jtl.IJtlTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		JTL.resource.jtl.IJtlTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
