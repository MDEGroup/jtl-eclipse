...
public class JtlStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, JTL.resource.jtl.IJtlFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, JTL.resource.jtl.IJtlFunction1<String, T> toStringFunction) {
