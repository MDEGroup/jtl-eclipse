...
/**
 * A JtlLayoutInformationAdapter is used to store layout information that is found
 ...
 * JtlLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class JtlLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<JTL.resource.jtl.mopp.JtlLayoutInformation> layoutInformations = new java.util.ArrayList<JTL.resource.jtl.mopp.JtlLayoutInformation>();
	...
	public java.util.List<JTL.resource.jtl.mopp.JtlLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(JTL.resource.jtl.mopp.JtlLayoutInformation layoutInformation) {
