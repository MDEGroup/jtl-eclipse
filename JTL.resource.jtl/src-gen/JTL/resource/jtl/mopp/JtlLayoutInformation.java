...
/**
 * JtlLayoutInformation objects are used to store layout information that is found
 ...
 * JtlLayoutInformations are aggregated in LayoutInformationAdapters. One
 * JtlLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class JtlLayoutInformation {
	 ...
	 */
	private final JTL.resource.jtl.grammar.JtlSyntaxElement syntaxElement;
	...
	public JtlLayoutInformation(JTL.resource.jtl.grammar.JtlSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public JTL.resource.jtl.grammar.JtlSyntaxElement getSyntaxElement() {
