 ...
 */
public class JtlExpectedTerminal {
	...
	private JTL.resource.jtl.IJtlExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private JTL.resource.jtl.grammar.JtlContainmentTrace containmentTrace;
	
	public JtlExpectedTerminal(org.eclipse.emf.ecore.EObject container, JTL.resource.jtl.IJtlExpectedElement terminal, int followSetID, JTL.resource.jtl.grammar.JtlContainmentTrace containmentTrace) {
		super();
	...
	public JTL.resource.jtl.IJtlExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		JtlExpectedTerminal otherExpectedTerminal = (JtlExpectedTerminal) o;
	...
	public JTL.resource.jtl.grammar.JtlContainmentTrace getContainmentTrace() {
