...
public class JtlNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "JTL.resource.jtl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {JTL.resource.jtl.mopp.JtlBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(JTL.resource.jtl.mopp.JtlBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
