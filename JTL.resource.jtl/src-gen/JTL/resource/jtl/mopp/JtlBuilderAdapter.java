...
public class JtlBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "JTL.resource.jtl.builder";
	
	private JTL.resource.jtl.IJtlBuilder defaultBuilder = new JTL.resource.jtl.mopp.JtlBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		JTL.resource.jtl.IJtlBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			JTL.resource.jtl.mopp.JtlResource customResource = (JTL.resource.jtl.mopp.JtlResource) resourceSet.getResource(uri, true);
			new JTL.resource.jtl.mopp.JtlMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public JTL.resource.jtl.IJtlBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new JTL.resource.jtl.mopp.JtlMarkerHelper().getMarkerID(JTL.resource.jtl.JtlEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		JTL.resource.jtl.mopp.JtlTaskItemBuilder taskItemBuilder = new JTL.resource.jtl.mopp.JtlTaskItemBuilder();
		new JTL.resource.jtl.mopp.JtlMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new JTL.resource.jtl.mopp.JtlMetaInformation().getSyntaxName())) {
