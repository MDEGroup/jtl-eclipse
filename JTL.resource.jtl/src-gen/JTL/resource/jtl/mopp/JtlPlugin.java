 ...
 */
public class JtlPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "JTL.resource.jtl";
	/**
	...
	private static JtlPlugin plugin;
	...
	public static JtlPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, JtlPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, JtlPlugin.PLUGIN_ID, message);
		}
		final JtlPlugin pluginInstance = JtlPlugin.getDefault();
