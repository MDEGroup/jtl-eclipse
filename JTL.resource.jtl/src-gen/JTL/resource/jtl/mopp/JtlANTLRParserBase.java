...
public abstract class JtlANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements JTL.resource.jtl.IJtlTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<JTL.resource.jtl.IJtlCommand<JTL.resource.jtl.IJtlTextResource>> postParseCommands;
	 ...
	 */
	private JTL.resource.jtl.mopp.JtlTokenResolveResult tokenResolveResult = new JTL.resource.jtl.mopp.JtlTokenResolveResult();
	
	protected JTL.resource.jtl.mopp.JtlMetaInformation metaInformation = new JTL.resource.jtl.mopp.JtlMetaInformation();
	
	public JtlANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public JtlANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, JTL.resource.jtl.grammar.JtlSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof JTL.resource.jtl.grammar.JtlPlaceholder;
		isElementToStore |= syntaxElement instanceof JTL.resource.jtl.grammar.JtlKeyword;
		isElementToStore |= syntaxElement instanceof JTL.resource.jtl.grammar.JtlEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof JTL.resource.jtl.grammar.JtlBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new JTL.resource.jtl.mopp.JtlLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(final JTL.resource.jtl.mopp.JtlContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final org.eclipse.emf.ecore.EReference reference, final String id, final org.eclipse.emf.ecore.EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = JTL.resource.jtl.util.JtlStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(JTL.resource.jtl.IJtlOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(JTL.resource.jtl.IJtlOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, JTL.resource.jtl.mopp.JtlDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = JTL.resource.jtl.util.JtlMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof JTL.resource.jtl.mopp.JtlDummyEObject);
			JTL.resource.jtl.mopp.JtlDummyEObject dummy = (JTL.resource.jtl.mopp.JtlDummyEObject) object;
	...
	protected JTL.resource.jtl.mopp.JtlTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected JTL.resource.jtl.mopp.JtlReferenceResolverSwitch getReferenceResolverSwitch() {
		JTL.resource.jtl.mopp.JtlReferenceResolverSwitch resolverSwitch = (JTL.resource.jtl.mopp.JtlReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
