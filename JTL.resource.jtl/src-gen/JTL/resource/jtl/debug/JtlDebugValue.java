...
public class JtlDebugValue extends JTL.resource.jtl.debug.JtlDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public JtlDebugValue(JTL.resource.jtl.debug.JtlDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
