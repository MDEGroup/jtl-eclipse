...
public class JtlLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "JTL.resource.jtl.debug.lineBreakpoint.marker";
	
	public JtlLineBreakpoint() {
		super();
	}
	
	public JtlLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(JTL.resource.jtl.debug.JtlDebugTarget target) {
		try {
	...
	public void remove(JTL.resource.jtl.debug.JtlDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
