...
public class JtlStackFrame extends JTL.resource.jtl.debug.JtlDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private JTL.resource.jtl.debug.JtlDebugTarget target;
	private String name;
	private int id;
	...
	public JtlStackFrame(JTL.resource.jtl.debug.JtlDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = JTL.resource.jtl.util.JtlStringUtil.decode(data, ',');
	...
	private JTL.resource.jtl.debug.JtlDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		JTL.resource.jtl.debug.JtlStackFrame other = (JTL.resource.jtl.debug.JtlStackFrame) obj;
		if (name == null) {
