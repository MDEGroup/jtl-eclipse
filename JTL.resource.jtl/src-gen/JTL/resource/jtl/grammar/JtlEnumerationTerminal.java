 ...
 */
public class JtlEnumerationTerminal extends JTL.resource.jtl.grammar.JtlTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public JtlEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, JTL.resource.jtl.grammar.JtlCardinality cardinality, int mandatoryOccurrencesAfter) {
