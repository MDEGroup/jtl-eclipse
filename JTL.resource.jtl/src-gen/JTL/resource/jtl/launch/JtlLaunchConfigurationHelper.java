 ...
 * 
 */
package JTL.resource.jtl.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class JtlLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends JTL.resource.jtl.util.AbstractJtlInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, JTL.resource.jtl.util.AbstractJtlInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final JTL.resource.jtl.debug.JtlDebuggableInterpreter<ResultType, ContextType> interpreter = new JTL.resource.jtl.debug.JtlDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		JTL.resource.jtl.debug.JtlDebuggerListener<ResultType, ContextType> debugListener = new JTL.resource.jtl.debug.JtlDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		JTL.resource.jtl.debug.JtlDebugProcess process = new JTL.resource.jtl.debug.JtlDebugProcess(launch);
		launch.addDebugTarget(new JTL.resource.jtl.debug.JtlDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(JTL.resource.jtl.launch.JtlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return JTL.resource.jtl.util.JtlResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, JTL.resource.jtl.mopp.JtlPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
