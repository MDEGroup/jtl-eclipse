 ...
 * given name.
 */
public class JtlReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements JTL.resource.jtl.IJtlReferenceCache {
	...
	private JTL.resource.jtl.IJtlNameProvider nameProvider;
	
	public JtlReferenceCache(JTL.resource.jtl.IJtlNameProvider nameProvider) {
		super();
