 ...
 */
public class JtlDefaultTokenResolver implements JTL.resource.jtl.IJtlTokenResolver {
	 ...
	 */
	public JtlDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public JtlDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, JTL.resource.jtl.IJtlTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : JTL.resource.jtl.grammar.JtlGrammarInformationProvider.INSTANCE.getKeywords()) {
