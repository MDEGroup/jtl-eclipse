 ...
 * </p>
 * <ul>
 *   <li>{@link JTL.emof.impl.ClassImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link JTL.emof.impl.ClassImpl#getOwnedOperation <em>Owned Operation</em>}</li>
 *   <li>{@link JTL.emof.impl.ClassImpl#getSuperClass <em>Super Class</em>}</li>
 *   <li>{@link JTL.emof.impl.ClassImpl#isIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends TypeImpl implements JTL.emof.Class {
	/**
	 ...
	 * @ordered
	 */
	protected EList<JTL.emof.Class> superClass;
	 ...
	 * @generated
	 */
	public EList<JTL.emof.Class> getSuperClass() {
		if (superClass == null) {
			superClass = new EObjectResolvingEList<JTL.emof.Class>(JTL.emof.Class.class, this, EmofPackage.CLASS__SUPER_CLASS);
		}
		return superClass;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmofPackage.CLASS__SUPER_CLASS:
				getSuperClass().clear();
				getSuperClass().addAll((Collection<? extends JTL.emof.Class>)newValue);
				return;
			case EmofPackage.CLASS__IS_ABSTRACT:
