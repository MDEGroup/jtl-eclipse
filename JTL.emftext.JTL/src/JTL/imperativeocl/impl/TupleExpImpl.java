 ...
 * </p>
 * <ul>
 *   <li>{@link JTL.imperativeocl.impl.TupleExpImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpImpl extends ImperativeExpressionImpl implements TupleExp {
	/**
	...
	protected EClass eStaticClass() {
		return ImperativeoclPackage.Literals.TUPLE_EXP;
	}
	...
	public EList<OclExpression> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<OclExpression>(OclExpression.class, this, ImperativeoclPackage.TUPLE_EXP__ELEMENT);
		}
		return element;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ImperativeoclPackage.TUPLE_EXP__ELEMENT:
