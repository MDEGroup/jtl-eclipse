 ...
 * </p>
 * <ul>
 *   <li>{@link JTL.imperativeocl.impl.UnpackExpImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnpackExpImpl extends ImperativeExpressionImpl implements UnpackExp {
	...
	public EList<Variable> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable>(Variable.class, this, ImperativeoclPackage.UNPACK_EXP__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ImperativeoclPackage.UNPACK_EXP__VARIABLE:
