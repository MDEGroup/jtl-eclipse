 ...
 * <!-- end-user-doc -->
 * @see JTL.template.TemplatePackage
 * @generated
 */
public class TemplateSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TemplatePackage.TEMPLATE_EXP: {
			...
			case TemplatePackage.OBJECT_TEMPLATE_EXP: {
			...
			case TemplatePackage.COLLECTION_TEMPLATE_EXP: {
			...
			case TemplatePackage.PROPERTY_TEMPLATE_ITEM: {
