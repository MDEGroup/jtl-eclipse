...
public class JTLFactoryImpl extends EFactoryImpl implements JTLFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case JTLPackage.DATA_TYPE: return createDataType();
			case JTLPackage.ENTITY: return createEntity();
			case JTLPackage.ENTITY_MODEL: return createEntityModel();
			case JTLPackage.FEATURE: return createFeature();
			default:
