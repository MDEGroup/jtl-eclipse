 ...
 */
public class AspmHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AspmHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				ASPM.resource.aspm.mopp.AspmPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
