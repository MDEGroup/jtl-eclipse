 ...
 * a specified depth.
 */
public class AspmOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public AspmOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = ASPM.resource.aspm.util.AspmStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof ASPM.resource.aspm.ui.AspmEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			ASPM.resource.aspm.mopp.AspmPlugin.logError("Exception while refreshing outline view", e);
		}
	}
