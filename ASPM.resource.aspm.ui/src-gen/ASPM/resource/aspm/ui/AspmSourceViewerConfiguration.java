 ...
 */
public class AspmSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private ASPM.resource.aspm.ui.AspmQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public AspmSourceViewerConfiguration(ASPM.resource.aspm.IAspmResourceProvider resourceProvider, ASPM.resource.aspm.ui.IAspmAnnotationModelProvider annotationModelProvider, ASPM.resource.aspm.ui.IAspmBracketHandlerProvider bracketHandlerProvider, ASPM.resource.aspm.ui.AspmColorManager colorManager) {
		super(ASPM.resource.aspm.ui.AspmUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new ASPM.resource.aspm.ui.AspmCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new ASPM.resource.aspm.ui.AspmTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new ASPM.resource.aspm.ui.AspmTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new ASPM.resource.aspm.ui.AspmHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new ASPM.resource.aspm.ui.AspmQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new ASPM.resource.aspm.ui.AspmIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
