 ...
 */
public class AspmPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ASPM.resource.aspm.ui.AspmUIPlugin.getDefault().getPreferenceStore());
		setDescription("Aspm Text Editor Preferences");
	}
