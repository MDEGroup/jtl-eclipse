 ...
 */
public class AspmNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new ASPM.resource.aspm.mopp.AspmMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("ASPM.resource.aspm.ui");
							...
							String natureID = ASPM.resource.aspm.mopp.AspmNature.NATURE_ID;
							...
							for (String builderID : ASPM.resource.aspm.mopp.AspmNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								ASPM.resource.aspm.mopp.AspmMetaInformation info = new ASPM.resource.aspm.mopp.AspmMetaInformation();
