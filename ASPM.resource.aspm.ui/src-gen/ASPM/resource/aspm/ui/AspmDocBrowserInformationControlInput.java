 ...
 * olInput</code>.
 */
public class AspmDocBrowserInformationControlInput {
	
	private final AspmDocBrowserInformationControlInput fPrevious;
	private AspmDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AspmDocBrowserInformationControlInput(AspmDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AspmDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AspmDocBrowserInformationControlInput getNext() {
		return fNext;
	}
