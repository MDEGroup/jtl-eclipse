 ...
 */
public class AspmNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AspmNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new aspm file");
