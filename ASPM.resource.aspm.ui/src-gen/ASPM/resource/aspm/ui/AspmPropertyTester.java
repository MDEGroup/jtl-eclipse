...
public class AspmPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new ASPM.resource.aspm.mopp.AspmMetaInformation().getSyntaxName());
	}
