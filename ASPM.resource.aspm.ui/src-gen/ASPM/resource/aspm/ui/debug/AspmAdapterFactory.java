 ...
 * 
 */
package ASPM.resource.aspm.ui.debug;

@SuppressWarnings("restriction")
public class AspmAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new ASPM.resource.aspm.mopp.AspmMetaInformation().getSyntaxName())) {
					return new ASPM.resource.aspm.ui.debug.AspmLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof ASPM.resource.aspm.debug.AspmDebugVariable) {
			final ASPM.resource.aspm.debug.AspmDebugVariable variable = (ASPM.resource.aspm.debug.AspmDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof ASPM.resource.aspm.debug.AspmDebugVariable) {
			final ASPM.resource.aspm.debug.AspmDebugVariable variable = (ASPM.resource.aspm.debug.AspmDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							ASPM.resource.aspm.debug.AspmDebugValue castedValue = (ASPM.resource.aspm.debug.AspmDebugValue) value;
