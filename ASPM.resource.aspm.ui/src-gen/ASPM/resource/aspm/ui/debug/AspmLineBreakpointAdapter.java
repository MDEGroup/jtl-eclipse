...
public class AspmLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(ASPM.resource.aspm.mopp.AspmPlugin.DEBUG_MODEL_ID);
			...
			ASPM.resource.aspm.debug.AspmLineBreakpoint lineBreakpoint = new ASPM.resource.aspm.debug.AspmLineBreakpoint(resource, lineNumber + 1);
