 ...
 */
public class AspmUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "ASPM.resource.aspm.ui";
	public static final String EDITOR_ID = "ASPM.resource.aspm.ui.AspmEditor";
	...
	private static AspmUIPlugin plugin;
	...
	public static AspmUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspmUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspmUIPlugin.PLUGIN_ID, message);
		}
		final AspmUIPlugin pluginInstance = AspmUIPlugin.getDefault();
