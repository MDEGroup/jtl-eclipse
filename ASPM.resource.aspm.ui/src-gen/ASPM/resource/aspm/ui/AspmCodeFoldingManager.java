 ...
 */
public class AspmCodeFoldingManager {
	
	private class FoldingUpdateListener implements ASPM.resource.aspm.IAspmBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ASPM.resource.aspm.ui.AspmEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ASPM.resource.aspm.ui.AspmEditor) {
				ASPM.resource.aspm.ui.AspmEditor editor = (ASPM.resource.aspm.ui.AspmEditor) workbenchPart;
	...
	protected ASPM.resource.aspm.ui.AspmEditor editor;
	 ...
	 */
	public AspmCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ASPM.resource.aspm.ui.AspmEditor textEditor) {
	...
	private void addCloseListener(final ASPM.resource.aspm.ui.AspmEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ASPM.resource.aspm.ui.AspmUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ASPM.resource.aspm.IAspmTextResource textResource = (ASPM.resource.aspm.IAspmTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
