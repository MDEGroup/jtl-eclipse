 ...
 */
public class AspmSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AspmSyntaxColoringPreferencePage() {
		super();
		
		ASPM.resource.aspm.mopp.AspmMetaInformation metaInformation = new ASPM.resource.aspm.mopp.AspmMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPM.resource.aspm.ui.AspmSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ASPM.resource.aspm.ui.AspmPixelConverter pixelConverter = new ASPM.resource.aspm.ui.AspmPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ASPM.resource.aspm.ui.AspmEditor) {
			ASPM.resource.aspm.ui.AspmEditor emfTextEditor = (ASPM.resource.aspm.ui.AspmEditor) editor;
