...
public class AspmOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			ASPM.resource.aspm.IAspmNameProvider nameProvider = new ASPM.resource.aspm.mopp.AspmMetaInformation().createNameProvider();
