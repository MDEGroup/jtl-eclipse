 ...
 * @since 3.2
 */
public class AspmBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private ASPM.resource.aspm.ui.AspmDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AspmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AspmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AspmBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof ASPM.resource.aspm.ui.AspmDocBrowserInformationControlInput);
		...
		fInput= (ASPM.resource.aspm.ui.AspmDocBrowserInformationControlInput) input;
		...
		ASPM.resource.aspm.ui.AspmHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = ASPM.resource.aspm.ui.AspmHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public ASPM.resource.aspm.ui.AspmDocBrowserInformationControlInput getInput() {
		return fInput;
	}
