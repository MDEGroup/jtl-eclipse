 ...
 */
public class AspmLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new ASPM.resource.aspm.mopp.AspmMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(ASPM.resource.aspm.launch.AspmLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			ASPM.resource.aspm.mopp.AspmPlugin.logError("Exception while launching selection", e);
		}
	}
