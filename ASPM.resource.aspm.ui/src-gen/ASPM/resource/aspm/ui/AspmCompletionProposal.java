 ...
 */
public class AspmCompletionProposal implements java.lang.Comparable<AspmCompletionProposal> {
	 ...
	 */
	private ASPM.resource.aspm.mopp.AspmExpectedTerminal expectedTerminal;
	...
	public AspmCompletionProposal(ASPM.resource.aspm.mopp.AspmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AspmCompletionProposal(ASPM.resource.aspm.mopp.AspmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AspmCompletionProposal(ASPM.resource.aspm.mopp.AspmExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public ASPM.resource.aspm.mopp.AspmExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof AspmCompletionProposal) {
			AspmCompletionProposal other = (AspmCompletionProposal) object;
	...
	public int compareTo(AspmCompletionProposal object) {
		if (object instanceof AspmCompletionProposal) {
			AspmCompletionProposal other = (AspmCompletionProposal) object;
