 ...
 */
public class AsptDefaultTokenResolver implements ASPT.resource.aspt.IAsptTokenResolver {
	 ...
	 */
	public AsptDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AsptDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ASPT.resource.aspt.IAsptTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : ASPT.resource.aspt.grammar.AsptGrammarInformationProvider.INSTANCE.getKeywords()) {
