 ...
 * given name.
 */
public class AsptReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements ASPT.resource.aspt.IAsptReferenceCache {
	...
	private ASPT.resource.aspt.IAsptNameProvider nameProvider;
	
	public AsptReferenceCache(ASPT.resource.aspt.IAsptNameProvider nameProvider) {
		super();
