 ...
 * 
 */
package ASPT.resource.aspt.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class AsptLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends ASPT.resource.aspt.util.AbstractAsptInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, ASPT.resource.aspt.util.AbstractAsptInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final ASPT.resource.aspt.debug.AsptDebuggableInterpreter<ResultType, ContextType> interpreter = new ASPT.resource.aspt.debug.AsptDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		ASPT.resource.aspt.debug.AsptDebuggerListener<ResultType, ContextType> debugListener = new ASPT.resource.aspt.debug.AsptDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		ASPT.resource.aspt.debug.AsptDebugProcess process = new ASPT.resource.aspt.debug.AsptDebugProcess(launch);
		launch.addDebugTarget(new ASPT.resource.aspt.debug.AsptDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(ASPT.resource.aspt.launch.AsptLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return ASPT.resource.aspt.util.AsptResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ASPT.resource.aspt.mopp.AsptPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
