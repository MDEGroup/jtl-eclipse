 ...
 * resolver
 */
public interface IAsptReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends ASPT.resource.aspt.IAsptConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, ASPT.resource.aspt.IAsptReferenceResolveResult<ReferenceType> result);
