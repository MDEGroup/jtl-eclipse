...
public class AsptGrammarInformationProvider {
	...
	public final static ASPT.resource.aspt.grammar.AsptPlaceholder ASPT_7_0_0_8 = new ASPT.resource.aspt.grammar.AsptPlaceholder(ASPT.ASPTPackage.eINSTANCE.getTraceLink().getEStructuralFeature(ASPT.ASPTPackage.TRACE_LINK__IDREF), "INTEGER", ASPT.resource.aspt.grammar.AsptCardinality.ONE, 0);
	...
	public final static ASPT.resource.aspt.grammar.AsptPlaceholder ASPT_7_0_0_10 = new ASPT.resource.aspt.grammar.AsptPlaceholder(ASPT.ASPTPackage.eINSTANCE.getTraceLink().getEStructuralFeature(ASPT.ASPTPackage.TRACE_LINK__IDREFX), "QUOTED_34_34", ASPT.resource.aspt.grammar.AsptCardinality.ONE, 0);
	...
	public final static ASPT.resource.aspt.grammar.AsptPlaceholder ASPT_7_0_0_12 = new ASPT.resource.aspt.grammar.AsptPlaceholder(ASPT.ASPTPackage.eINSTANCE.getTraceLink().getEStructuralFeature(ASPT.ASPTPackage.TRACE_LINK__TYPE), "IDENTIFIER", ASPT.resource.aspt.grammar.AsptCardinality.ONE, 0);
	...
	public final static ASPT.resource.aspt.grammar.AsptPlaceholder ASPT_7_0_0_14 = new ASPT.resource.aspt.grammar.AsptPlaceholder(ASPT.ASPTPackage.eINSTANCE.getTraceLink().getEStructuralFeature(ASPT.ASPTPackage.TRACE_LINK__RELATION), "QUOTED_34_34", ASPT.resource.aspt.grammar.AsptCardinality.ONE, 0);
