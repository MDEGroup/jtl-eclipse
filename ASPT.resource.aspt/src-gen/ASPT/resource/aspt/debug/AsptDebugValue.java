...
public class AsptDebugValue extends ASPT.resource.aspt.debug.AsptDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public AsptDebugValue(ASPT.resource.aspt.debug.AsptDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
