...
public class AsptLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "ASPT.resource.aspt.debug.lineBreakpoint.marker";
	
	public AsptLineBreakpoint() {
		super();
	}
	
	public AsptLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(ASPT.resource.aspt.debug.AsptDebugTarget target) {
		try {
	...
	public void remove(ASPT.resource.aspt.debug.AsptDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
