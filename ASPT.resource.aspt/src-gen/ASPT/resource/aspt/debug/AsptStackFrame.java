...
public class AsptStackFrame extends ASPT.resource.aspt.debug.AsptDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private ASPT.resource.aspt.debug.AsptDebugTarget target;
	private String name;
	private int id;
	...
	public AsptStackFrame(ASPT.resource.aspt.debug.AsptDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = ASPT.resource.aspt.util.AsptStringUtil.decode(data, ',');
	...
	private ASPT.resource.aspt.debug.AsptDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		ASPT.resource.aspt.debug.AsptStackFrame other = (ASPT.resource.aspt.debug.AsptStackFrame) obj;
		if (name == null) {
