...
public class AsptRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			ASPT.resource.aspt.mopp.AsptPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			ASPT.resource.aspt.mopp.AsptPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
