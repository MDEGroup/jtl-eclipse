...
public class AsptStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, ASPT.resource.aspt.IAsptFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, ASPT.resource.aspt.IAsptFunction1<String, T> toStringFunction) {
