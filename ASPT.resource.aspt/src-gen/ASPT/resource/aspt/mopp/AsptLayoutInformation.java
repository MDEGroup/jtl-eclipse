...
/**
 * AsptLayoutInformation objects are used to store layout information that is
 ...
 * AsptLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AsptLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AsptLayoutInformation {
	 ...
	 */
	private final ASPT.resource.aspt.grammar.AsptSyntaxElement syntaxElement;
	...
	public AsptLayoutInformation(ASPT.resource.aspt.grammar.AsptSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ASPT.resource.aspt.grammar.AsptSyntaxElement getSyntaxElement() {
