...
public class AsptANTLRTextToken extends ASPT.resource.aspt.mopp.AsptTextToken {
	
	private final static ASPT.resource.aspt.IAsptMetaInformation metaInformation = new ASPT.resource.aspt.mopp.AsptMetaInformation();
	
	public AsptANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
