...
/**
 * A AsptLayoutInformationAdapter is used to store layout information that is
 ...
 * AsptLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class AsptLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<ASPT.resource.aspt.mopp.AsptLayoutInformation> layoutInformations = new java.util.ArrayList<ASPT.resource.aspt.mopp.AsptLayoutInformation>();
	...
	public java.util.List<ASPT.resource.aspt.mopp.AsptLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(ASPT.resource.aspt.mopp.AsptLayoutInformation layoutInformation) {
