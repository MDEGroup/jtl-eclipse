...
public class AsptBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "ASPT.resource.aspt.builder";
	
	private ASPT.resource.aspt.IAsptBuilder defaultBuilder = new ASPT.resource.aspt.mopp.AsptBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		ASPT.resource.aspt.IAsptBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			ASPT.resource.aspt.mopp.AsptResource customResource = (ASPT.resource.aspt.mopp.AsptResource) resourceSet.getResource(uri, true);
			new ASPT.resource.aspt.mopp.AsptMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public ASPT.resource.aspt.IAsptBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new ASPT.resource.aspt.mopp.AsptMarkerHelper().getMarkerID(ASPT.resource.aspt.AsptEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		ASPT.resource.aspt.mopp.AsptTaskItemBuilder taskItemBuilder = new ASPT.resource.aspt.mopp.AsptTaskItemBuilder();
		new ASPT.resource.aspt.mopp.AsptMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new ASPT.resource.aspt.mopp.AsptMetaInformation().getSyntaxName())) {
