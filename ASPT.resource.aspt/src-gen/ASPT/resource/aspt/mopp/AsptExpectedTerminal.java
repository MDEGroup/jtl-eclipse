 ...
 */
public class AsptExpectedTerminal {
	...
	private ASPT.resource.aspt.IAsptExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private ASPT.resource.aspt.grammar.AsptContainmentTrace containmentTrace;
	
	public AsptExpectedTerminal(org.eclipse.emf.ecore.EObject container, ASPT.resource.aspt.IAsptExpectedElement terminal, int followSetID, ASPT.resource.aspt.grammar.AsptContainmentTrace containmentTrace) {
		super();
	...
	public ASPT.resource.aspt.IAsptExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		AsptExpectedTerminal otherExpectedTerminal = (AsptExpectedTerminal) o;
	...
	public ASPT.resource.aspt.grammar.AsptContainmentTrace getContainmentTrace() {
