 ...
 */
public class AsptPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "ASPT.resource.aspt";
	/**
	...
	private static AsptPlugin plugin;
	...
	public static AsptPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, AsptPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, AsptPlugin.PLUGIN_ID, message);
		}
		final AsptPlugin pluginInstance = AsptPlugin.getDefault();
