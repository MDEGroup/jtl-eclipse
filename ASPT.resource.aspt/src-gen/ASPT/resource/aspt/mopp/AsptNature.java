...
public class AsptNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "ASPT.resource.aspt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ASPT.resource.aspt.mopp.AsptBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ASPT.resource.aspt.mopp.AsptBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
