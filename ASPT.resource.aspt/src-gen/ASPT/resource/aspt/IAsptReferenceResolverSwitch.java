...
/**
 * A IAsptReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IAsptReferenceResolverSwitch extends ASPT.resource.aspt.IAsptConfigurable {
