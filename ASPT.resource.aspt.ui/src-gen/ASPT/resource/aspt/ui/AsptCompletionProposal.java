 ...
 */
public class AsptCompletionProposal implements java.lang.Comparable<AsptCompletionProposal> {
	 ...
	 */
	private ASPT.resource.aspt.mopp.AsptExpectedTerminal expectedTerminal;
	...
	public AsptCompletionProposal(ASPT.resource.aspt.mopp.AsptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AsptCompletionProposal(ASPT.resource.aspt.mopp.AsptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AsptCompletionProposal(ASPT.resource.aspt.mopp.AsptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public ASPT.resource.aspt.mopp.AsptExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof AsptCompletionProposal) {
			AsptCompletionProposal other = (AsptCompletionProposal) object;
	...
	public int compareTo(AsptCompletionProposal object) {
		if (object instanceof AsptCompletionProposal) {
			AsptCompletionProposal other = (AsptCompletionProposal) object;
