 ...
 * a specified depth.
 */
public class AsptOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public AsptOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = ASPT.resource.aspt.util.AsptStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof ASPT.resource.aspt.ui.AsptEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			ASPT.resource.aspt.mopp.AsptPlugin.logError("Exception while refreshing outline view", e);
		}
	}
