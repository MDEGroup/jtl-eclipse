 ...
 */
public class AsptPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ASPT.resource.aspt.ui.AsptUIPlugin.getDefault().getPreferenceStore());
		setDescription("Aspt Text Editor Preferences");
	}
