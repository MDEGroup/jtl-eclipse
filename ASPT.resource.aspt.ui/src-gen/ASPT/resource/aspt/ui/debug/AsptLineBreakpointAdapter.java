...
public class AsptLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(ASPT.resource.aspt.mopp.AsptPlugin.DEBUG_MODEL_ID);
			...
			ASPT.resource.aspt.debug.AsptLineBreakpoint lineBreakpoint = new ASPT.resource.aspt.debug.AsptLineBreakpoint(resource, lineNumber + 1);
