...
public class AsptPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof ASPT.resource.aspt.ui.AsptEObjectSelection) {
			final ASPT.resource.aspt.ui.AsptEObjectSelection selection = (ASPT.resource.aspt.ui.AsptEObjectSelection) iSelection;
