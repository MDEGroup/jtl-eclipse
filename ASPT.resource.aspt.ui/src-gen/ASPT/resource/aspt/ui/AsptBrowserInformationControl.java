 ...
 * @since 3.2
 */
public class AsptBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AsptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AsptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AsptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput);
		...
		fInput= (ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput) input;
		...
		ASPT.resource.aspt.ui.AsptHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = ASPT.resource.aspt.ui.AsptHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput getInput() {
		return fInput;
	}
