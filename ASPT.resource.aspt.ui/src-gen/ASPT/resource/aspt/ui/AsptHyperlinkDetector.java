 ...
 * hovers, is a proxy.
 */
public class AsptHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public AsptHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (ASPT.resource.aspt.IAsptTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new ASPT.resource.aspt.ui.AsptHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
