 ...
 */
public class AsptNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AsptNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new aspt file");
