 ...
 */
public class AsptTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private ASPT.resource.aspt.IAsptHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final ASPT.resource.aspt.ui.AsptBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(ASPT.resource.aspt.ui.AsptBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput infoInput = (ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					ASPT.resource.aspt.ui.AsptHyperlink hyperlink = new ASPT.resource.aspt.ui.AsptHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (ASPT.resource.aspt.ui.AsptBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				ASPT.resource.aspt.ui.AsptBrowserInformationControl iControl = new ASPT.resource.aspt.ui.AsptBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput) {
							ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput input = (ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (ASPT.resource.aspt.ui.AsptBrowserInformationControl.isAvailable(parent)) {
				ASPT.resource.aspt.ui.AsptBrowserInformationControl iControl = new ASPT.resource.aspt.ui.AsptBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AsptTextHover(ASPT.resource.aspt.IAsptResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new ASPT.resource.aspt.ui.AsptUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				ASPT.resource.aspt.ui.AsptHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			ASPT.resource.aspt.ui.AsptHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			ASPT.resource.aspt.ui.AsptHTMLPrinter.insertPageProlog(buffer, 0, ASPT.resource.aspt.ui.AsptTextHover.getStyleSheet());
			ASPT.resource.aspt.ui.AsptHTMLPrinter.addPageEpilog(buffer);
			return new ASPT.resource.aspt.ui.AsptDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = ASPT.resource.aspt.ui.AsptHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(ASPT.resource.aspt.ui.AsptUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return ASPT.resource.aspt.util.AsptStreamUtil.getContent(styleSheetURL.openStream());
