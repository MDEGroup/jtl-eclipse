 ...
 */
public class AsptLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new ASPT.resource.aspt.mopp.AsptMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(ASPT.resource.aspt.launch.AsptLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			ASPT.resource.aspt.mopp.AsptPlugin.logError("Exception while launching selection", e);
		}
	}
