 ...
 */
public class AsptUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "ASPT.resource.aspt.ui";
	public static final String EDITOR_ID = "ASPT.resource.aspt.ui.AsptEditor";
	...
	private static AsptUIPlugin plugin;
	...
	public static AsptUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AsptUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AsptUIPlugin.PLUGIN_ID, message);
		}
		final AsptUIPlugin pluginInstance = AsptUIPlugin.getDefault();
