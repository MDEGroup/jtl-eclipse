 ...
 */
public class AsptCodeFoldingManager {
	
	private class FoldingUpdateListener implements ASPT.resource.aspt.IAsptBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ASPT.resource.aspt.ui.AsptEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ASPT.resource.aspt.ui.AsptEditor) {
				ASPT.resource.aspt.ui.AsptEditor editor = (ASPT.resource.aspt.ui.AsptEditor) workbenchPart;
	...
	protected ASPT.resource.aspt.ui.AsptEditor editor;
	 ...
	 */
	public AsptCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ASPT.resource.aspt.ui.AsptEditor textEditor) {
	...
	private void addCloseListener(final ASPT.resource.aspt.ui.AsptEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ASPT.resource.aspt.ui.AsptUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ASPT.resource.aspt.IAsptTextResource textResource = (ASPT.resource.aspt.IAsptTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
