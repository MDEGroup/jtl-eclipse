 ...
 */
public class AsptHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AsptHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				ASPT.resource.aspt.mopp.AsptPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
