...
public class AsptNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private ASPT.resource.aspt.ui.AsptNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public AsptNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new ASPT.resource.aspt.ui.AsptNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			ASPT.resource.aspt.ui.AsptUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			ASPT.resource.aspt.ui.AsptUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new ASPT.resource.aspt.mopp.AsptMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new ASPT.resource.aspt.mopp.AsptMetaInformation().getSyntaxName();
	}
	
	public ASPT.resource.aspt.IAsptMetaInformation getMetaInformation() {
