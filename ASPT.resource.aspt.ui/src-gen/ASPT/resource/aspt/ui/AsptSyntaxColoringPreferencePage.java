 ...
 */
public class AsptSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AsptSyntaxColoringPreferencePage() {
		super();
		
		ASPT.resource.aspt.mopp.AsptMetaInformation metaInformation = new ASPT.resource.aspt.mopp.AsptMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ASPT.resource.aspt.ui.AsptSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ASPT.resource.aspt.ui.AsptPixelConverter pixelConverter = new ASPT.resource.aspt.ui.AsptPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ASPT.resource.aspt.ui.AsptEditor) {
			ASPT.resource.aspt.ui.AsptEditor emfTextEditor = (ASPT.resource.aspt.ui.AsptEditor) editor;
