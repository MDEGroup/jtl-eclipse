 ...
 */
public class AsptNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new ASPT.resource.aspt.mopp.AsptMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("ASPT.resource.aspt.ui");
							...
							String natureID = ASPT.resource.aspt.mopp.AsptNature.NATURE_ID;
							...
							for (String builderID : ASPT.resource.aspt.mopp.AsptNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								ASPT.resource.aspt.mopp.AsptMetaInformation info = new ASPT.resource.aspt.mopp.AsptMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = ASPT.resource.aspt.ui.AsptUIPlugin.getDefault().getBundle();
