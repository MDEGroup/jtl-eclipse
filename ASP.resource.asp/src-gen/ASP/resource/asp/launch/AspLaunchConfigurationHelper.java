 ...
 * 
 */
package ASP.resource.asp.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class AspLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends ASP.resource.asp.util.AbstractAspInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, ASP.resource.asp.util.AbstractAspInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final ASP.resource.asp.debug.AspDebuggableInterpreter<ResultType, ContextType> interpreter = new ASP.resource.asp.debug.AspDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		ASP.resource.asp.debug.AspDebuggerListener<ResultType, ContextType> debugListener = new ASP.resource.asp.debug.AspDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		ASP.resource.asp.debug.AspDebugProcess process = new ASP.resource.asp.debug.AspDebugProcess(launch);
		launch.addDebugTarget(new ASP.resource.asp.debug.AspDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(ASP.resource.asp.launch.AspLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return ASP.resource.asp.util.AspResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ASP.resource.asp.mopp.AspPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
