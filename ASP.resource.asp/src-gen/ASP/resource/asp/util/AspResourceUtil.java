...
public class AspResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new ASP.resource.asp.util.AspInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new ASP.resource.asp.util.AspInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static ASP.resource.asp.mopp.AspResource getResource(java.io.File file) {
	...
	public static ASP.resource.asp.mopp.AspResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new ASP.resource.asp.mopp.AspMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (ASP.resource.asp.mopp.AspResource) resource;
	}
	 ...
	 */
	public static ASP.Transformation getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static ASP.Transformation getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (ASP.Transformation) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static ASP.Transformation getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		ASP.resource.asp.IAspTextResource resource = (ASP.resource.asp.IAspTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (ASP.resource.asp.IAspTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		ASP.resource.asp.IAspTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
