...
/**
 * AspLayoutInformation objects are used to store layout information that is found
 ...
 * AspLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AspLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AspLayoutInformation {
	 ...
	 */
	private final ASP.resource.asp.grammar.AspSyntaxElement syntaxElement;
	...
	public AspLayoutInformation(ASP.resource.asp.grammar.AspSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ASP.resource.asp.grammar.AspSyntaxElement getSyntaxElement() {
