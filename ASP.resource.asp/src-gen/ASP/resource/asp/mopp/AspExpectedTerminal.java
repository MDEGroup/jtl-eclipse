 ...
 */
public class AspExpectedTerminal {
	...
	private ASP.resource.asp.IAspExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private ASP.resource.asp.grammar.AspContainmentTrace containmentTrace;
	
	public AspExpectedTerminal(org.eclipse.emf.ecore.EObject container, ASP.resource.asp.IAspExpectedElement terminal, int followSetID, ASP.resource.asp.grammar.AspContainmentTrace containmentTrace) {
		super();
	...
	public ASP.resource.asp.IAspExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		AspExpectedTerminal otherExpectedTerminal = (AspExpectedTerminal) o;
	...
	public ASP.resource.asp.grammar.AspContainmentTrace getContainmentTrace() {
