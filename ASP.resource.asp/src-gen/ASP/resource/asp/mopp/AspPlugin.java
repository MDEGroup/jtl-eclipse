 ...
 */
public class AspPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "ASP.resource.asp";
	/**
	...
	private static AspPlugin plugin;
	...
	public static AspPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, AspPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, AspPlugin.PLUGIN_ID, message);
		}
		final AspPlugin pluginInstance = AspPlugin.getDefault();
