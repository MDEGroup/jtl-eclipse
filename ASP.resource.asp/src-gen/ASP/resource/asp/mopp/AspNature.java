...
public class AspNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "ASP.resource.asp.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ASP.resource.asp.mopp.AspBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ASP.resource.asp.mopp.AspBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
