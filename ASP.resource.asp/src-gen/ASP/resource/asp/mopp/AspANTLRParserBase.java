...
public abstract class AspANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements ASP.resource.asp.IAspTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<ASP.resource.asp.IAspCommand<ASP.resource.asp.IAspTextResource>> postParseCommands;
	 ...
	 */
	private ASP.resource.asp.mopp.AspTokenResolveResult tokenResolveResult = new ASP.resource.asp.mopp.AspTokenResolveResult();
	
	protected ASP.resource.asp.mopp.AspMetaInformation metaInformation = new ASP.resource.asp.mopp.AspMetaInformation();
	
	public AspANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public AspANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, ASP.resource.asp.grammar.AspSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof ASP.resource.asp.grammar.AspPlaceholder;
		isElementToStore |= syntaxElement instanceof ASP.resource.asp.grammar.AspKeyword;
		isElementToStore |= syntaxElement instanceof ASP.resource.asp.grammar.AspEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof ASP.resource.asp.grammar.AspBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		ASP.resource.asp.mopp.AspLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new ASP.resource.asp.mopp.AspLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(final ASP.resource.asp.mopp.AspContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final org.eclipse.emf.ecore.EReference reference, final String id, final org.eclipse.emf.ecore.EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = ASP.resource.asp.util.AspStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(ASP.resource.asp.IAspOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(ASP.resource.asp.IAspOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, ASP.resource.asp.mopp.AspDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = ASP.resource.asp.util.AspMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof ASP.resource.asp.mopp.AspDummyEObject);
			ASP.resource.asp.mopp.AspDummyEObject dummy = (ASP.resource.asp.mopp.AspDummyEObject) object;
	...
	protected ASP.resource.asp.mopp.AspTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected ASP.resource.asp.mopp.AspReferenceResolverSwitch getReferenceResolverSwitch() {
		ASP.resource.asp.mopp.AspReferenceResolverSwitch resolverSwitch = (ASP.resource.asp.mopp.AspReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
