...
public class AspBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "ASP.resource.asp.builder";
	
	private ASP.resource.asp.IAspBuilder defaultBuilder = new ASP.resource.asp.mopp.AspBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		ASP.resource.asp.IAspBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			ASP.resource.asp.mopp.AspResource customResource = (ASP.resource.asp.mopp.AspResource) resourceSet.getResource(uri, true);
			new ASP.resource.asp.mopp.AspMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public ASP.resource.asp.IAspBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new ASP.resource.asp.mopp.AspMarkerHelper().getMarkerID(ASP.resource.asp.AspEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		ASP.resource.asp.mopp.AspTaskItemBuilder taskItemBuilder = new ASP.resource.asp.mopp.AspTaskItemBuilder();
		new ASP.resource.asp.mopp.AspMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new ASP.resource.asp.mopp.AspMetaInformation().getSyntaxName())) {
