...
/**
 * A AspLayoutInformationAdapter is used to store layout information that is found
 ...
 * AspLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class AspLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<ASP.resource.asp.mopp.AspLayoutInformation> layoutInformations = new java.util.ArrayList<ASP.resource.asp.mopp.AspLayoutInformation>();
	...
	public java.util.List<ASP.resource.asp.mopp.AspLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(ASP.resource.asp.mopp.AspLayoutInformation layoutInformation) {
