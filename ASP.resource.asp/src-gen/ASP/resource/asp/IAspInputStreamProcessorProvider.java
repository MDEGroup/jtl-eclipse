 ...
 * conversion.
 */
public interface IAspInputStreamProcessorProvider {
	 ...
	 */
	public ASP.resource.asp.mopp.AspInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
