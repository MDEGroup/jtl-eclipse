 ...
 */
public class AspDefaultTokenResolver implements ASP.resource.asp.IAspTokenResolver {
	 ...
	 */
	public AspDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AspDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ASP.resource.asp.IAspTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : ASP.resource.asp.grammar.AspGrammarInformationProvider.INSTANCE.getKeywords()) {
