 ...
 * given name.
 */
public class AspReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements ASP.resource.asp.IAspReferenceCache {
	...
	private ASP.resource.asp.IAspNameProvider nameProvider;
	
	public AspReferenceCache(ASP.resource.asp.IAspNameProvider nameProvider) {
		super();
