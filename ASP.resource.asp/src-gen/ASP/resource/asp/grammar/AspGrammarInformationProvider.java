...
public class AspGrammarInformationProvider {
	...
	public final static ASP.resource.asp.grammar.AspLineBreak ASP_3_0_0_4 = new ASP.resource.asp.grammar.AspLineBreak(ASP.resource.asp.grammar.AspCardinality.ONE, 0);
	public final static ASP.resource.asp.grammar.AspSequence ASP_3_0_0 = new ASP.resource.asp.grammar.AspSequence(ASP.resource.asp.grammar.AspCardinality.ONE, ASP_3_0_0_0, ASP_3_0_0_1, ASP_3_0_0_2, ASP_3_0_0_3, ASP_3_0_0_4);
	...
	public final static ASP.resource.asp.grammar.AspKeyword ASP_10_0_0_0 = new ASP.resource.asp.grammar.AspKeyword(":-", ASP.resource.asp.grammar.AspCardinality.ONE);
	public final static ASP.resource.asp.grammar.AspWhiteSpace ASP_10_0_0_1 = new ASP.resource.asp.grammar.AspWhiteSpace(1, ASP.resource.asp.grammar.AspCardinality.ONE);
	public final static ASP.resource.asp.grammar.AspContainment ASP_10_0_0_2 = new ASP.resource.asp.grammar.AspContainment(ASP.ASPPackage.eINSTANCE.getConstraint().getEStructuralFeature(ASP.ASPPackage.CONSTRAINT__EXPRESSIONS), ASP.resource.asp.grammar.AspCardinality.ONE, new org.eclipse.emf.ecore.EClass[] {ASP.ASPPackage.eINSTANCE.getExpression(), }, 0);
	public final static ASP.resource.asp.grammar.AspKeyword ASP_10_0_0_3_0_0_0 = new ASP.resource.asp.grammar.AspKeyword(",", ASP.resource.asp.grammar.AspCardinality.ONE);
	public final static ASP.resource.asp.grammar.AspWhiteSpace ASP_10_0_0_3_0_0_1 = new ASP.resource.asp.grammar.AspWhiteSpace(1, ASP.resource.asp.grammar.AspCardinality.ONE);
	public final static ASP.resource.asp.grammar.AspContainment ASP_10_0_0_3_0_0_2 = new ASP.resource.asp.grammar.AspContainment(ASP.ASPPackage.eINSTANCE.getConstraint().getEStructuralFeature(ASP.ASPPackage.CONSTRAINT__EXPRESSIONS), ASP.resource.asp.grammar.AspCardinality.ONE, new org.eclipse.emf.ecore.EClass[] {ASP.ASPPackage.eINSTANCE.getExpression(), }, 0);
	public final static ASP.resource.asp.grammar.AspSequence ASP_10_0_0_3_0_0 = new ASP.resource.asp.grammar.AspSequence(ASP.resource.asp.grammar.AspCardinality.ONE, ASP_10_0_0_3_0_0_0, ASP_10_0_0_3_0_0_1, ASP_10_0_0_3_0_0_2);
	public final static ASP.resource.asp.grammar.AspChoice ASP_10_0_0_3_0 = new ASP.resource.asp.grammar.AspChoice(ASP.resource.asp.grammar.AspCardinality.ONE, ASP_10_0_0_3_0_0);
	public final static ASP.resource.asp.grammar.AspCompound ASP_10_0_0_3 = new ASP.resource.asp.grammar.AspCompound(ASP_10_0_0_3_0, ASP.resource.asp.grammar.AspCardinality.STAR);
	public final static ASP.resource.asp.grammar.AspWhiteSpace ASP_10_0_0_4 = new ASP.resource.asp.grammar.AspWhiteSpace(0, ASP.resource.asp.grammar.AspCardinality.ONE);
	...
	public final static ASP.resource.asp.grammar.AspLineBreak ASP_10_0_0_6 = new ASP.resource.asp.grammar.AspLineBreak(ASP.resource.asp.grammar.AspCardinality.ONE, 0);
	public final static ASP.resource.asp.grammar.AspSequence ASP_10_0_0 = new ASP.resource.asp.grammar.AspSequence(ASP.resource.asp.grammar.AspCardinality.ONE, ASP_10_0_0_0, ASP_10_0_0_1, ASP_10_0_0_2, ASP_10_0_0_3, ASP_10_0_0_4, ASP_10_0_0_5, ASP_10_0_0_6);
