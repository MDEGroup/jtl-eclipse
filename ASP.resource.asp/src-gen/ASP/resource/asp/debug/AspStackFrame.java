...
public class AspStackFrame extends ASP.resource.asp.debug.AspDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private ASP.resource.asp.debug.AspDebugTarget target;
	private String name;
	private int id;
	...
	public AspStackFrame(ASP.resource.asp.debug.AspDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = ASP.resource.asp.util.AspStringUtil.decode(data, ',');
	...
	private ASP.resource.asp.debug.AspDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		ASP.resource.asp.debug.AspStackFrame other = (ASP.resource.asp.debug.AspStackFrame) obj;
		if (name == null) {
