...
public class AspDebugValue extends ASP.resource.asp.debug.AspDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public AspDebugValue(ASP.resource.asp.debug.AspDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
