...
public class AspLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "ASP.resource.asp.debug.lineBreakpoint.marker";
	
	public AspLineBreakpoint() {
		super();
	}
	
	public AspLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(ASP.resource.asp.debug.AspDebugTarget target) {
		try {
	...
	public void remove(ASP.resource.asp.debug.AspDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
